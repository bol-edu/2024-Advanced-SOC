...
go new
go analyze
solution design set ATTENTION_IP::Attention_Top -top
solution design set ATTENTION_IP::Attention_Calculator -block
go compile
solution library add nangate-45nm_beh -- -rtlsyntool DesignCompiler -vendor Nangate -technology 045nm
solution library add ccs_sample_mem
solution library add {[Block] ATTENTION_IP::Attention_Buffer.v2}
solution library add {[Block] ATTENTION_IP::Attention_Calculator.v4}
solution library add {[Block] ATTENTION_IP::Attention_Filter.v2}
go libraries
...
directive set /ATTENTION_IP::Attention_Top/ATTENTION_IP::Attention_Calculator -MAP_TO_MODULE {[Block] ATTENTION_IP::Attention_Calculator.v4}
directive set /ATTENTION_IP::Attention_Top/ATTENTION_IP::Attention_Filter -MAP_TO_MODULE {[Block] ATTENTION_IP::Attention_Filter.v2}
directive set /ATTENTION_IP::Attention_Top/ATTENTION_IP::Attention_Buffer -MAP_TO_MODULE {[Block] ATTENTION_IP::Attention_Buffer.v2}
go assembly
directive set /ATTENTION_IP::Attention_Top/q_chan1:cns -FIFO_DEPTH 0
directive set /ATTENTION_IP::Attention_Top/k_chan1:cns -FIFO_DEPTH 0
directive set /ATTENTION_IP::Attention_Top/v_chan1:cns -FIFO_DEPTH 0
directive set /ATTENTION_IP::Attention_Top/q_chan2:cns -FIFO_DEPTH 0
directive set /ATTENTION_IP::Attention_Top/k_chan2:cns -FIFO_DEPTH 0
directive set /ATTENTION_IP::Attention_Top/v_chan2:cns -FIFO_DEPTH 0
go architect
go extract
