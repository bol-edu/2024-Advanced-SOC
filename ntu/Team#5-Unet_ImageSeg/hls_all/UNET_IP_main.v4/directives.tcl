...
solution options set /Input/SearchPath /home/raid7_2/user12/r12016/asoc/final/hlsall
solution options set /Output/GenerateCycleNetlist false
solution file add ../hlsall/main_all.h -type CHEADER
...
go assembly
directive set /UNET_IP::main/run/for#2:for:for:for:for:for -PIPELINE_INIT_INTERVAL 1
directive set /UNET_IP::main/run/for#3:for -PIPELINE_INIT_INTERVAL 1
directive set /UNET_IP::main/run/for#5:for:for:for:for:for -PIPELINE_INIT_INTERVAL 1
directive set /UNET_IP::main/run/for#6:for -PIPELINE_INIT_INTERVAL 1
directive set /UNET_IP::main/run/for#7:for:for:for:for -PIPELINE_INIT_INTERVAL 1
