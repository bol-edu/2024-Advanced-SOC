...
// Generated date: Thu Jun 13 02:36:35 CST 2024
//
// ----------------------------------------------------------------------------
#ifdef CCS_SCVERIFY
...
public:
   ...
   sc_port< tlm::tlm_fifo_put_if< ac_int<3, false > > > ccs_pool_size;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_pool_size;
   ...
   bool width_mismatch;
   bool _capture_pool_size;
   int pool_size_capture_count;
   int pool_size_iteration_count;
   ac_int<3, false > pool_size_prev_value;
   bool pool_size_idle_warning;
   bool pool_size_mismatch;
   bool _capture_stride;
   int stride_capture_count;
   int stride_iteration_count;
   ac_int<3, false > stride_prev_value;
   bool stride_idle_warning;
   bool stride_mismatch;
   int wait_cnt;
   ...
   mc_testbench(
      ...
      , ccs_pool_size("ccs_pool_size")
      , ccs_wait_ctrl_pool_size("ccs_wait_ctrl_pool_size")
   ...
   public:
      void capture_pool_size( ac_int<3, false > &pool_size) ;
   public:
      void capture_stride( ac_int<3, false > &stride) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN(ac_fixed<12, 8, true, AC_TRN, AC_WRAP> input[32768], ac_fixed<12, 8, true, AC_TRN, AC_WRAP> output[32768], ac_int<7, false> &channels, ac_int<7, false> &height, ac_int<7, false> &width, ac_int<3, false> &pool_size, ac_int<3, false> &stride) ;
   public:
      static void capture_OUT(ac_fixed<12, 8, true, AC_TRN, AC_WRAP> input[32768], ac_fixed<12, 8, true, AC_TRN, AC_WRAP> output[32768], ac_int<7, false> &channels, ac_int<7, false> &height, ac_int<7, false> &width, ac_int<3, false> &pool_size, ac_int<3, false> &stride) ;
   public:
      static void exec_run_max(ac_fixed<12, 8, true, AC_TRN, AC_WRAP> input[32768], ac_fixed<12, 8, true, AC_TRN, AC_WRAP> output[32768], ac_int<7, false> &channels, ac_int<7, false> &height, ac_int<7, false> &width, ac_int<3, false> &pool_size, ac_int<3, false> &stride) ;
   protected:
