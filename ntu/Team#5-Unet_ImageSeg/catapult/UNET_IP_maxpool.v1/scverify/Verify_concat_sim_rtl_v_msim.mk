...
# Generated date: Thu Jun 13 02:36:51 CST 2024
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_maxpool.v1
#   WORKING_DIR   /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_maxpool.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/UNET_IP_maxpool.v1
PROJ2SOLN = ./Catapult/UNET_IP_maxpool.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_maxpool.v1/concat_sim_rtl.v
endif
...
export SCVLIBS
export MODELSIM
TOP_HDL_ENTITY           := UNET_IP_maxpool
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult/UNET_IP_maxpool.v1/scverify_msim.tcl
...
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_UNET_IP_maxpool.v/ccs_wrapper_UNET_IP_maxpool.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_rtl.v/concat_sim_rtl.v.vts ./scverify/ccs_wrapper_UNET_IP_maxpool.v/ccs_wrapper_UNET_IP_maxpool.v.vts
endif
...
CXXFLAGS += $(COMPILERFLAGS) -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_UNET_IP_maxpool_run_max -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: ./scverify/ccs_wrapper_UNET_IP_maxpool.v
...
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
$(TARGET)/$(notdir $(GATE_VHDL_DEP)): HDL_LIB=work
$(TARGET)/$(notdir $(GATE_VHDL_DEP)): DUT_E=UNET_IP_maxpool
endif
ifneq ($(GATE_VLOG_DEP),)
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): HDL_LIB=work
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): DUT_E=UNET_IP_maxpool
endif
endif
# 
# Specify additional HDL source compilation options if any
$(TARGET)/concat_sim_rtl.v.vts: VLOG_F_OPTS=
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: VLOG_F_OPTS=
$(TARGET)/concat_sim_rtl.v.vts: NCVLOG_F_OPTS=
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: NCVLOG_F_OPTS=
$(TARGET)/concat_sim_rtl.v.vts: VCS_F_OPTS=
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: VCS_F_OPTS=
# 
# Specify top design unit for HDL source
$(TARGET)/concat_sim_rtl.v.vts: DUT_E=UNET_IP_maxpool
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: DUT_E=ccs_wrapper

# Specify top design unit
$(TARGET)/ccs_wrapper_UNET_IP_maxpool.v.vts: VLOG_TOP=1
