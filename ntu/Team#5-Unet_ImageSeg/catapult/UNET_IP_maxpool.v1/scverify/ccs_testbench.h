...
class testbench
{
   ...
   static bool pool_size_ignore;
   static bool pool_size_skip;
   static bool pool_size_skip_quiet;
   static bool pool_size_skip_once;
   static bool pool_size_skip_noerr;
   static int  pool_size_array_comp_first;
   static int  pool_size_array_comp_last;
   static mc_wait_ctrl pool_size_wait_ctrl;
...
extern void mc_testbench_pool_size_skip(bool v);
