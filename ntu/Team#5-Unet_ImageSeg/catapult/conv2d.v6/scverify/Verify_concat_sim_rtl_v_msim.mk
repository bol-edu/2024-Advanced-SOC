...
# Generated date: Thu Jun 13 02:27:40 CST 2024
#
# ----------------------------------------------------------------------------
# ===================================================
...
RTL_NETLIST_FNAME           = /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/conv2d.v6/concat_sim_rtl.v
endif
...
VLOG_SRC +=  $(GATE_VLOG_DEP) ./scverify/ccs_wrapper_UNET_IP_conv2d.v/ccs_wrapper_UNET_IP_conv2d.v.vts
else
VHDL_SRC += 
VLOG_SRC += ./concat_sim_rtl.v/concat_sim_rtl.v.vts ./scverify/ccs_wrapper_UNET_IP_conv2d.v/ccs_wrapper_UNET_IP_conv2d.v.vts
endif
...
$(TARGET)/$(notdir $(GATE_VHDL_DEP)): DUT_E=UNET_IP_conv2d
endif
ifneq ($(GATE_VLOG_DEP),)
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): HDL_LIB=work
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): DUT_E=UNET_IP_conv2d
endif
endif
# 
...
$(TARGET)/concat_sim_rtl.v.vts: DUT_E=UNET_IP_conv2d
