...
#include "/home/raid7_4/raid1_1/linux/mentor/Catapult/2023.2/Mgc_home/pkgs/ccs_xilinx/hdl/DIST_1R1W_RBW_trans_rsc.h"
...
public:
  ...
  sc_signal<sc_lv<16> >                                                                              TLS_padded_input_rsc_wadr;
  sc_signal<sc_lv<12> >                                                                              TLS_padded_input_rsc_d;
  sc_signal<sc_logic>                                                                                TLS_padded_input_rsc_we;
  sc_signal<sc_lv<16> >                                                                              TLS_padded_input_rsc_radr;
  sc_signal<sc_logic>                                                                                TLS_padded_input_rsc_re;
  sc_signal<sc_lv<12> >                                                                              TLS_padded_input_rsc_q;
  sc_signal<sc_logic>                                                                                TLS_padded_input_rsc_clken;
  sc_signal<sc_logic>                                                                                TLS_padded_input_triosy_lz;
  ...
  sc_signal<sc_lv<2> >                                                                               TLS_kernel_size;
  sc_signal<sc_lv<2> >                                                                               TLS_padding;
  sc_signal<sc_lv<20> >                                                                              TLS_filter_offset;
  sc_signal<sc_lv<7> >                                                                               TLS_in_channels;
  sc_signal<sc_lv<7> >                                                                               TLS_out_channels;
  ccs_DUT_wrapper                                                                                    UNET_IP_conv2d_INST;
  sc_signal<sc_lv<12> >                                                                              TLS_input_rsc_d;
  sc_signal<sc_lv<15> >                                                                              TLS_input_rsc_wadr;
  sc_signal<sc_logic >                                                                               TLS_input_rsc_we;
  DIST_1R1W_RBW_trans_rsc<15,12,32768,1 >                                                            input_rsc_INST;
  BLOCK_1R1W_RBW_trans_rsc<16,12,34848,1 >                                                           padded_input_rsc_INST;
  ...
  mgc_in_wire_trans_rsc_v1<1,2 >                                                                     kernel_size_rsc_INST;
  mgc_in_wire_trans_rsc_v1<1,2 >                                                                     padding_rsc_INST;
  mgc_in_wire_trans_rsc_v1<1,20 >                                                                    filter_offset_rsc_INST;
  mgc_in_wire_trans_rsc_v1<1,7 >                                                                     in_channels_rsc_INST;
  mgc_in_wire_trans_rsc_v1<1,7 >                                                                     out_channels_rsc_INST;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> >                TLS_in_fifo_padded_input;
  tlm::tlm_fifo<mc_wait_ctrl>                                                                        TLS_in_wait_ctrl_fifo_padded_input;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> >                TLS_out_fifo_padded_input;
  tlm::tlm_fifo<mc_wait_ctrl>                                                                        TLS_out_wait_ctrl_fifo_padded_input;
  mc_trios_inout_monitor                                                                             trios_monitor_padded_input_triosy_lz_INST;
  mc_inout_transactor<mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848>,12,true>   transactor_padded_input;
  ...
  tlm::tlm_fifo<ac_int<2, false > >                                                                  TLS_in_fifo_padding;
  tlm::tlm_fifo<mc_wait_ctrl>                                                                        TLS_in_wait_ctrl_fifo_padding;
  mc_input_transactor<ac_int<2, false >,2,false>                                                     transactor_padding;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_padded_input_rsc_wadr("TLS_padded_input_rsc_wadr")
    , TLS_padded_input_rsc_d("TLS_padded_input_rsc_d")
    , TLS_padded_input_rsc_we("TLS_padded_input_rsc_we")
    , TLS_padded_input_rsc_radr("TLS_padded_input_rsc_radr")
    , TLS_padded_input_rsc_re("TLS_padded_input_rsc_re")
    , TLS_padded_input_rsc_q("TLS_padded_input_rsc_q")
    , TLS_padded_input_rsc_clken("TLS_padded_input_rsc_clken")
    , TLS_padded_input_triosy_lz("TLS_padded_input_triosy_lz")
    ...
    , TLS_width("TLS_width")
    , TLS_kernel_size("TLS_kernel_size")
    , TLS_padding("TLS_padding")
    , TLS_filter_offset("TLS_filter_offset")
    , TLS_in_channels("TLS_in_channels")
    , TLS_out_channels("TLS_out_channels")
    , UNET_IP_conv2d_INST("rtl", "ccs_wrapper")
    ...
    , padded_input_rsc_INST("padded_input_rsc", true)
    ...
    , padding_rsc_INST("padding_rsc", true)
    ...
    , TLS_in_fifo_padded_input("TLS_in_fifo_padded_input", -1)
    , TLS_in_wait_ctrl_fifo_padded_input("TLS_in_wait_ctrl_fifo_padded_input", -1)
    , TLS_out_fifo_padded_input("TLS_out_fifo_padded_input", -1)
    , TLS_out_wait_ctrl_fifo_padded_input("TLS_out_wait_ctrl_fifo_padded_input", -1)
    , trios_monitor_padded_input_triosy_lz_INST("trios_monitor_padded_input_triosy_lz_INST")
    , transactor_padded_input("transactor_padded_input", 0, 12, 0)
    ...
    , TLS_in_fifo_padding("TLS_in_fifo_padding", 1)
    , TLS_in_wait_ctrl_fifo_padding("TLS_in_wait_ctrl_fifo_padding", 1)
    , transactor_padding("transactor_padding", 0, 2, 0, d_disable_on_empty)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 200856, 200856, 0)
    , catapult_monitor_INST("Monitor", clk, true, 200856LL, 200856LL)
    ...
    , deadlocked("deadlocked")
  {
    ...
    UNET_IP_conv2d_INST.clk(clk);
    UNET_IP_conv2d_INST.rst(TLS_rst);
    UNET_IP_conv2d_INST.arst_n(TLS_arst_n);
    UNET_IP_conv2d_INST.input_rsc_radr(TLS_input_rsc_radr);
    UNET_IP_conv2d_INST.input_rsc_re(TLS_input_rsc_re);
    UNET_IP_conv2d_INST.input_rsc_q(TLS_input_rsc_q);
    UNET_IP_conv2d_INST.input_rsc_clken(TLS_input_rsc_clken);
    UNET_IP_conv2d_INST.input_triosy_lz(TLS_input_triosy_lz);
    UNET_IP_conv2d_INST.padded_input_rsc_wadr(TLS_padded_input_rsc_wadr);
    UNET_IP_conv2d_INST.padded_input_rsc_d(TLS_padded_input_rsc_d);
    UNET_IP_conv2d_INST.padded_input_rsc_we(TLS_padded_input_rsc_we);
    UNET_IP_conv2d_INST.padded_input_rsc_radr(TLS_padded_input_rsc_radr);
    UNET_IP_conv2d_INST.padded_input_rsc_re(TLS_padded_input_rsc_re);
    UNET_IP_conv2d_INST.padded_input_rsc_q(TLS_padded_input_rsc_q);
    UNET_IP_conv2d_INST.padded_input_rsc_clken(TLS_padded_input_rsc_clken);
    UNET_IP_conv2d_INST.padded_input_triosy_lz(TLS_padded_input_triosy_lz);
    UNET_IP_conv2d_INST.output_rsc_wadr(TLS_output_rsc_wadr);
    UNET_IP_conv2d_INST.output_rsc_d(TLS_output_rsc_d);
    UNET_IP_conv2d_INST.output_rsc_we(TLS_output_rsc_we);
    UNET_IP_conv2d_INST.output_rsc_clken(TLS_output_rsc_clken);
    UNET_IP_conv2d_INST.output_triosy_lz(TLS_output_triosy_lz);
    UNET_IP_conv2d_INST.height(TLS_height);
    UNET_IP_conv2d_INST.width(TLS_width);
    UNET_IP_conv2d_INST.kernel_size(TLS_kernel_size);
    UNET_IP_conv2d_INST.padding(TLS_padding);
    UNET_IP_conv2d_INST.filter_offset(TLS_filter_offset);
    UNET_IP_conv2d_INST.in_channels(TLS_in_channels);
    UNET_IP_conv2d_INST.out_channels(TLS_out_channels);
    ...
    padded_input_rsc_INST.clken(TLS_padded_input_rsc_clken);
    padded_input_rsc_INST.q(TLS_padded_input_rsc_q);
    padded_input_rsc_INST.re(TLS_padded_input_rsc_re);
    padded_input_rsc_INST.radr(TLS_padded_input_rsc_radr);
    padded_input_rsc_INST.we(TLS_padded_input_rsc_we);
    padded_input_rsc_INST.d(TLS_padded_input_rsc_d);
    padded_input_rsc_INST.wadr(TLS_padded_input_rsc_wadr);
    padded_input_rsc_INST.clk(clk);
    padded_input_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_2)));
    ...
    kernel_size_rsc_INST.z(TLS_kernel_size);
    kernel_size_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_6)));

    padding_rsc_INST.clk(clk);
    padding_rsc_INST.z(TLS_padding);
    padding_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_7)));

    filter_offset_rsc_INST.clk(clk);
    filter_offset_rsc_INST.z(TLS_filter_offset);
    filter_offset_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_8)));

    in_channels_rsc_INST.clk(clk);
    in_channels_rsc_INST.z(TLS_in_channels);
    in_channels_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_9)));

    out_channels_rsc_INST.clk(clk);
    out_channels_rsc_INST.z(TLS_out_channels);
    out_channels_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_10)));
    ...
    trios_monitor_padded_input_triosy_lz_INST.trios(TLS_padded_input_triosy_lz);
    trios_monitor_padded_input_triosy_lz_INST.register_mon(&catapult_monitor_INST);

    transactor_padded_input.in_fifo(TLS_in_fifo_padded_input);
    transactor_padded_input.in_wait_ctrl_fifo(TLS_in_wait_ctrl_fifo_padded_input);
    transactor_padded_input.out_fifo(TLS_out_fifo_padded_input);
    transactor_padded_input.out_wait_ctrl_fifo(TLS_out_wait_ctrl_fifo_padded_input);
    transactor_padded_input.bind_clk(clk, true, rst);
    transactor_padded_input.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_padded_input.register_block(&padded_input_rsc_INST, padded_input_rsc_INST.basename(), TLS_padded_input_triosy_lz, 0, 34847, 1);
    ...
    if (!d_idle_sync_enabled) { transactor_kernel_size.register_block(&kernel_size_rsc_INST, kernel_size_rsc_INST.basename(), in_sync, 0, 0, 1); }
    if (d_idle_sync_enabled) { transactor_kernel_size.register_block(&kernel_size_rsc_INST, kernel_size_rsc_INST.basename(), TLS_design_is_idle, 0, 0, 1); }

    transactor_padding.in_fifo(TLS_in_fifo_padding);
    transactor_padding.in_wait_ctrl_fifo(TLS_in_wait_ctrl_fifo_padding);
    transactor_padding.set_disable_on_empty(d_disable_on_empty);
    transactor_padding.bind_clk(clk, true, rst);
    transactor_padding.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    if (!d_idle_sync_enabled) { transactor_padding.register_block(&padding_rsc_INST, padding_rsc_INST.basename(), in_sync, 0, 0, 1); }
    if (d_idle_sync_enabled) { transactor_padding.register_block(&padding_rsc_INST, padding_rsc_INST.basename(), TLS_design_is_idle, 0, 0, 1); }
    ...
    if (!d_idle_sync_enabled) { transactor_filter_offset.register_block(&filter_offset_rsc_INST, filter_offset_rsc_INST.basename(), in_sync, 0, 0, 1); }
    if (d_idle_sync_enabled) { transactor_filter_offset.register_block(&filter_offset_rsc_INST, filter_offset_rsc_INST.basename(), TLS_design_is_idle, 0, 0, 1); }
    ...
    if (!d_idle_sync_enabled) { transactor_in_channels.register_block(&in_channels_rsc_INST, in_channels_rsc_INST.basename(), in_sync, 0, 0, 1); }
    if (d_idle_sync_enabled) { transactor_in_channels.register_block(&in_channels_rsc_INST, in_channels_rsc_INST.basename(), TLS_design_is_idle, 0, 0, 1); }
    ...
    if (!d_idle_sync_enabled) { transactor_out_channels.register_block(&out_channels_rsc_INST, out_channels_rsc_INST.basename(), in_sync, 0, 0, 1); }
    if (d_idle_sync_enabled) { transactor_out_channels.register_block(&out_channels_rsc_INST, out_channels_rsc_INST.basename(), TLS_design_is_idle, 0, 0, 1); }

    testbench_INST.clk(clk);
    testbench_INST.ccs_input(TLS_in_fifo_input);
    testbench_INST.ccs_wait_ctrl_input(TLS_in_wait_ctrl_fifo_input);
    testbench_INST.ccs_padded_input_IN(TLS_in_fifo_padded_input);
    testbench_INST.ccs_wait_ctrl_padded_input_IN(TLS_in_wait_ctrl_fifo_padded_input);
    testbench_INST.ccs_padded_input(TLS_out_fifo_padded_input);
    testbench_INST.ccs_wait_ctrl_padded_input(TLS_out_wait_ctrl_fifo_padded_input);
    ...
    testbench_INST.ccs_padding(TLS_in_fifo_padding);
    testbench_INST.ccs_wait_ctrl_padding(TLS_in_wait_ctrl_fifo_padding);
...
void scverify_top::read_env() {
  ...
  unsigned long latency_est = 200850;
...
void scverify_top::setup_autowait() {
  ...
  transactor_padded_input.set_auto_wait_limit(env_SCVerify_AUTOWAIT);
  transactor_padded_input.configure_autowait(autowait_output_cfg);
  ...
  transactor_padding.set_auto_wait_limit(env_SCVerify_AUTOWAIT);
  transactor_padding.configure_autowait(autowait_input_cfg);
...
void scverify_top::inform_autowait() {
  ...
  waited |= (transactor_padded_input.atleast_one_autowait(1) > 0);
  ...
  waited |= (transactor_padding.atleast_one_autowait(0) > 0);
...
void scverify_top::setup_debug() {
  ...
  static int transactor_padded_input_flags = MC_DEFAULT_TRANSACTOR_LOG;
  ...
  static int transactor_padding_flags = MC_DEFAULT_TRANSACTOR_LOG;
  ...
  static int transactor_padded_input_flags = (d_disable_on_empty ? 0 : MC_TRANSACTOR_UNDERFLOW) | MC_TRANSACTOR_WAIT;
  ...
  static int transactor_kernel_size_flags = 0;
  static int transactor_padding_flags = 0;
  static int transactor_filter_offset_flags = 0;
  static int transactor_in_channels_flags = 0;
  static int transactor_out_channels_flags = 0;
#endif
  static int transactor_input_count = -1;
  static int transactor_padded_input_count = -1;
  ...
  static int transactor_padding_count = -1;
  ...
  if (debug_cmds.is_open()) {
    ...
    debug("transactor_padded_input",transactor_padded_input_flags,transactor_padded_input_count);
    ...
    debug("transactor_padding",transactor_padding_flags,transactor_padding_count);
...
void scverify_top::debug(const char* varname, int flags, int count) {
  ...
  if (strcmp(varname,"transactor_padded_input") == 0)
    xlator_p = &transactor_padded_input;
  ...
  if (strcmp(varname,"transactor_padding") == 0)
    xlator_p = &transactor_padding;
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    if (toggle_hw_reset) {
      ...
      transactor_padded_input.reset_streams();
      ...
      transactor_padding.reset_streams();
