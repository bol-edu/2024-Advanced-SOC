...
public:
   ...
   mc_comparator< mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> , MaskPacket< 0, 12 > > *padded_input_comp;
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> > > ccs_padded_input_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_padded_input_IN;
   sc_port< tlm::tlm_fifo_get_if< mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> > > ccs_padded_input;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_padded_input;
   ...
   sc_port< tlm::tlm_fifo_put_if< ac_int<2, false > > > ccs_padding;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_padding;
   ...
   bool _capture_padded_input_IN;
   int padded_input_IN_capture_count;
   int padded_input_IN_iteration_count;
   tlm::tlm_fifo< mc_golden_info< mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848>, MaskPacket<0, 12> > > padded_input_golden;
   bool _capture_padded_input;
   int padded_input_capture_count;
   int padded_input_iteration_count;
   ...
   ac_int<2, false > kernel_size_prev_value;
   bool kernel_size_idle_warning;
   bool kernel_size_mismatch;
   bool _capture_padding;
   int padding_capture_count;
   int padding_iteration_count;
   ac_int<2, false > padding_prev_value;
   bool padding_idle_warning;
   bool padding_mismatch;
   bool _capture_filter_offset;
   int filter_offset_capture_count;
   int filter_offset_iteration_count;
   ac_int<20, false > filter_offset_prev_value;
   bool filter_offset_idle_warning;
   bool filter_offset_mismatch;
   bool _capture_in_channels;
   int in_channels_capture_count;
   int in_channels_iteration_count;
   ac_int<7, false > in_channels_prev_value;
   bool in_channels_idle_warning;
   bool in_channels_mismatch;
   bool _capture_out_channels;
   int out_channels_capture_count;
   int out_channels_iteration_count;
   ac_int<7, false > out_channels_prev_value;
   bool out_channels_idle_warning;
   bool out_channels_mismatch;
   int wait_cnt;
   ...
   mc_testbench(
      ...
      , ccs_padded_input_IN("ccs_padded_input_IN")
      , ccs_wait_ctrl_padded_input_IN("ccs_wait_ctrl_padded_input_IN")
      , ccs_padded_input("ccs_padded_input")
      , ccs_wait_ctrl_padded_input("ccs_wait_ctrl_padded_input")
      ...
      , ccs_padding("ccs_padding")
      , ccs_wait_ctrl_padding("ccs_wait_ctrl_padding")
      ...
      , padded_input_golden("padded_input_golden",-1)
      , output_golden("output_golden",-1)
   {
      // Instantiate other modules
      padded_input_comp = new mc_comparator< mgc_sysc_ver_array1D<ac_fixed<12, 8, true, AC_TRN, AC_WRAP >,34848> , MaskPacket< 0, 12 > > (
         "padded_input_comp",
         "padded_input",
         0,
      ...
      padded_input_comp->data_in(ccs_padded_input);
      padded_input_comp->data_golden(padded_input_golden);
      ...
      _failed = false;
      _capture_input = true;
      _capture_padded_input_IN = true;
      _capture_padded_input = true;
      _capture_output = true;
      _capture_height = true;
      _capture_width = true;
      _capture_kernel_size = true;
      _capture_padding = true;
   ...
   public:
      void capture_padded_input_IN( ac_fixed<12, 8, true, AC_TRN, AC_WRAP > padded_input[34848]) ;
   public:
      void capture_padded_input( ac_fixed<12, 8, true, AC_TRN, AC_WRAP > padded_input[34848]) ;
   public:
   ...
   public:
      void capture_padding( ac_int<2, false > &padding) ;
   public:
