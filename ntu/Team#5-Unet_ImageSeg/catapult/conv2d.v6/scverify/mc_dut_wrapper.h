...
public:
  ...
  sc_out<sc_lv<16> > padded_input_rsc_wadr;
  sc_out<sc_lv<12> > padded_input_rsc_d;
  sc_out<sc_logic> padded_input_rsc_we;
  sc_out<sc_lv<16> > padded_input_rsc_radr;
  sc_out<sc_logic> padded_input_rsc_re;
  sc_in<sc_lv<12> > padded_input_rsc_q;
  sc_out<sc_logic> padded_input_rsc_clken;
  sc_out<sc_logic> padded_input_triosy_lz;
  ...
  sc_in<sc_lv<7> > width;
  sc_in<sc_lv<2> > kernel_size;
  sc_in<sc_lv<2> > padding;
  sc_in<sc_lv<20> > filter_offset;
  sc_in<sc_lv<7> > in_channels;
  sc_in<sc_lv<7> > out_channels;
public:
  ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
  :
