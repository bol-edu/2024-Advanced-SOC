...
solution design set UNET_IP::conv2d -top
go analyze
solution design set UNET_IP::main -block
solution design set UNET_IP::conv2d -top
go compile
...
go assembly
directive set /UNET_IP::conv2d/input:rsc -GEN_EXTERNAL_ENABLE true
directive set /UNET_IP::conv2d/padded_input:rsc -GEN_EXTERNAL_ENABLE true
directive set /UNET_IP::conv2d/output:rsc -GEN_EXTERNAL_ENABLE true
directive set /UNET_IP::conv2d/height:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/width:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/kernel_size:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/padding:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/filter_offset:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/in_channels:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d/out_channels:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /UNET_IP::conv2d -RESET_CLEARS_ALL_REGS no
directive set /UNET_IP::conv2d/input:rsc -MAP_TO_MODULE {Xilinx_RAMS.DIST_1R1W_RBW suppress_sim_read_addr_range_errs=1}
