...
class testbench
{
   ...
   static mc_wait_ctrl output_IN_wait_ctrl;
   ...
   static bool stride_ignore;
   static bool stride_skip;
   static bool stride_skip_quiet;
   static bool stride_skip_once;
   static bool stride_skip_noerr;
   static int  stride_array_comp_first;
   static int  stride_array_comp_last;
   static mc_wait_ctrl stride_wait_ctrl;
...
extern void mc_testbench_stride_skip(bool v);
