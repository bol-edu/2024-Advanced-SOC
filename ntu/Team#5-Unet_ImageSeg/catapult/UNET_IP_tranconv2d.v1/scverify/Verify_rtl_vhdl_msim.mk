...
# Generated date: Thu Jun 13 03:36:03 CST 2024
#
# ----------------------------------------------------------------------------
# ===================================================
...
#   SOLUTION_DIR  /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_tranconv2d.v1
#   WORKING_DIR   /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_tranconv2d.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./Catapult/UNET_IP_tranconv2d.v1
PROJ2SOLN = ./Catapult/UNET_IP_tranconv2d.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/raid7_2/user12/r12016/asoc/final/catapult2/Catapult/UNET_IP_tranconv2d.v1/rtl.vhdl
endif
...
export SCVLIBS
export MODELSIM
TOP_HDL_ENTITY           := UNET_IP_tranconv2d
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./Catapult/UNET_IP_tranconv2d.v1/scverify_msim.tcl
...
VHDL_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.vhd/ccs_in_v1.vhd.vhdlts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.vhd/mgc_io_sync_v2.vhd.vhdlts ./rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl/rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl.vhdlts $(GATE_VHDL_DEP) ./scverify/ccs_wrapper_UNET_IP_tranconv2d.vhdl/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts
VLOG_SRC +=  $(GATE_VLOG_DEP) 
else
VHDL_SRC += $(MGC_HOME)/pkgs/siflibs/ccs_in_v1.vhd/ccs_in_v1.vhd.vhdlts $(MGC_HOME)/pkgs/siflibs/mgc_io_sync_v2.vhd/mgc_io_sync_v2.vhd.vhdlts ./rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl/rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl.vhdlts ./rtl.vhdl/rtl.vhdl.vhdlts ./scverify/ccs_wrapper_UNET_IP_tranconv2d.vhdl/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts
VLOG_SRC += 
endif
...
CXXFLAGS += $(COMPILERFLAGS) -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_UNET_IP_tranconv2d_run_tran -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
...
$(TARGET)/rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl.vhdlts: ./rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl
$(TARGET)/rtl.vhdl.vhdlts: ./rtl.vhdl
$(TARGET)/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts: ./scverify/ccs_wrapper_UNET_IP_tranconv2d.vhdl
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts: HDL_LIB=work
$(TARGET)/rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl.vhdlts: HDL_LIB=mgc_hls
...
$(TARGET)/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts: VHDL_F_OPTS=
$(TARGET)/rtl_UNET_IP_tranconv2dmgc_rom_11_485120_5_1.vhdl.vhdlts: VHDL_F_OPTS=
...
$(TARGET)/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts: DUT_E=ccs_wrapper
$(TARGET)/rtl.vhdl.vhdlts: DUT_E=UNET_IP_tranconv2d

# Specify top design unit
$(TARGET)/ccs_wrapper_UNET_IP_tranconv2d.vhdl.vhdlts: VHDL_TOP=1
