...
(
  ...
  /*
`ifdef USER_PROJECT_SIDEBAND_SUPPORT
  wire [25:0] dat_in_rsc_dat = {ss_tupsb[1:0], ss_tdata[23:0]};
  `else
  wire [25:0] dat_in_rsc_dat = {2'b00,         ss_tdata[23:0]};
  `endif*/
    ...
    if ( !axi_reset_n ) begin
      ...
      if ( awvalid_in && wvalid_in ) begin		//when awvalid_in=1 and wvalid_in=1 means awready_out=1 and wready_out=1
        if          (awaddr[11:2] == 10'h000 ) begin //offset 0
          if ( wstrb[0] == 1) reg_rst           <= wdata[0];//wdata[0];!!!!!!!!!!!!!!!!!!!!!!
  ...
  always @(posedge axi_clk or negedge axi_reset_n)  begin
    if ( !axi_reset_n ) begin
        reg2_edgedetect_done <= 0;
    end else begin
    if(ss_tlast)
        reg2_edgedetect_done <= 1;
      else if ( awvalid_in && wvalid_in ) begin        //when awvalid_in=1 and wvalid_in=1 means awready_out=1 and wready_out=1 
        if (awaddr[11:2] == 10'h006 ) begin //offset 6
          if ( wstrb[0] == 1) reg2_edgedetect_done <= 0;
        end
      end
    end
  end
...
assign edgedetect_done = dat_out_rsc_dat[24];
/*
  ...
  .line_buf1_rsc_adr       (ram1_adr          )  //O
    ...
    // Address signals
    wire [9:0] ram0_r_adr, ram0_g_adr, ram0_b_adr;
    wire [9:0] ram1_r_adr, ram1_g_adr, ram1_b_adr;

    // Data signals
    wire [15:0] ram0_r_d, ram0_g_d, ram0_b_d;
    wire [11:0] ram1_r_d, ram1_g_d, ram1_b_d;

    // Enable signals
    wire ram0_r_en, ram0_g_en, ram0_b_en;
    wire ram1_r_en, ram1_g_en, ram1_b_en;

    // Write enable signals
    wire ram0_r_we, ram0_g_we, ram0_b_we;
    wire ram1_r_we, ram1_g_we, ram1_b_we;

    // Output data signals
    wire [15:0] ram0_r_q, ram0_g_q, ram0_b_q;
    wire [11:0] ram1_r_q, ram1_g_q, ram1_b_q;
...
EdgeDetect_IP_EdgeDetect_Top U_EdgeDetect(
  ...
  .dat_in_rsc_vld                       (ss_tvalid),
  .dat_in_rsc_rdy                       (dat_in_rsc_rdy),
  .widthIn                              (reg_widthIn),
  .heightIn                             (reg_heightIn),
  .dat_out_rsc_dat                      (dat_out_rsc_dat),
  .dat_out_rsc_vld                      (sm_tvalid),
  .dat_out_rsc_rdy                      (sm_tready),
  
  // Line Buffer 0 - Red
  .line_buf0_r_pixelType_rsc_en         (ram0_r_en),
  .line_buf0_r_pixelType_rsc_q          (ram0_r_q),
  .line_buf0_r_pixelType_rsc_we         (ram0_r_we),
  .line_buf0_r_pixelType_rsc_d          (ram0_r_d),
  .line_buf0_r_pixelType_rsc_adr        (ram0_r_adr),
  
  // Line Buffer 0 - Green
  .line_buf0_g_pixelType_rsc_en         (ram0_g_en),
  .line_buf0_g_pixelType_rsc_q          (ram0_g_q),
  .line_buf0_g_pixelType_rsc_we         (ram0_g_we),
  .line_buf0_g_pixelType_rsc_d          (ram0_g_d),
  .line_buf0_g_pixelType_rsc_adr        (ram0_g_adr),
  
  // Line Buffer 0 - Blue
  .line_buf0_b_pixelType_rsc_en         (ram0_b_en),
  .line_buf0_b_pixelType_rsc_q          (ram0_b_q),
  .line_buf0_b_pixelType_rsc_we         (ram0_b_we),
  .line_buf0_b_pixelType_rsc_d          (ram0_b_d),
  .line_buf0_b_pixelType_rsc_adr        (ram0_b_adr),
  
  // Line Buffer 1 - Red
  .line_buf1_r_pixelType_rsc_en         (ram1_r_en),
  .line_buf1_r_pixelType_rsc_q          (ram1_r_q),
  .line_buf1_r_pixelType_rsc_we         (ram1_r_we),
  .line_buf1_r_pixelType_rsc_d          (ram1_r_d),
  .line_buf1_r_pixelType_rsc_adr        (ram1_r_adr),
  
  // Line Buffer 1 - Green
  .line_buf1_g_pixelType_rsc_en         (ram1_g_en),
  .line_buf1_g_pixelType_rsc_q          (ram1_g_q),
  .line_buf1_g_pixelType_rsc_we         (ram1_g_we),
  .line_buf1_g_pixelType_rsc_d          (ram1_g_d),
  .line_buf1_g_pixelType_rsc_adr        (ram1_g_adr),
  
  // Line Buffer 1 - Blue
  .line_buf1_b_pixelType_rsc_en         (ram1_b_en),
  .line_buf1_b_pixelType_rsc_q          (ram1_b_q),
  .line_buf1_b_pixelType_rsc_we         (ram1_b_we),
  .line_buf1_b_pixelType_rsc_d          (ram1_b_d),
  .line_buf1_b_pixelType_rsc_adr        (ram1_b_adr)
);


// SRAM for Red Channel - Line Buffer 0
SPRAM #(.data_width(16), .addr_width(10), .depth(1024)) U_SPRAM_r0_r(
  .adr (ram0_r_adr),
  .d   (ram0_r_d),
  .en  (ram0_r_en),
  .we  (ram0_r_we),
...
// SRAM for Green Channel - Line Buffer 0
SPRAM #(.data_width(16), .addr_width(10), .depth(1024)) U_SPRAM_r0_g(
  .adr (ram0_g_adr),
  .d   (ram0_g_d),
  .en  (ram0_g_en),
  .we  (ram0_g_we),
...
// SRAM for Blue Channel - Line Buffer 0
SPRAM #(.data_width(16), .addr_width(10), .depth(1024)) U_SPRAM_r0_b(
  .adr (ram0_b_adr),
  .d   (ram0_b_d),
  .en  (ram0_b_en),
  .we  (ram0_b_we),
...
// SRAM for Red Channel - Line Buffer 1
SPRAM #(.data_width(12), .addr_width(10), .depth(1024)) U_SPRAM_r1_r(
  .adr (ram1_r_adr),
  .d   (ram1_r_d),
  .en  (ram1_r_en),
  .we  (ram1_r_we),
...
// SRAM for Green Channel - Line Buffer 1
SPRAM #(.data_width(12), .addr_width(10), .depth(1024)) U_SPRAM_r1_g(
  .adr (ram1_g_adr),
  .d   (ram1_g_d),
  .en  (ram1_g_en),
  .we  (ram1_g_we),
...
// SRAM for Blue Channel - Line Buffer 1
SPRAM #(.data_width(12), .addr_width(10), .depth(1024)) U_SPRAM_r1_b(
  .adr (ram1_b_adr),
  .d   (ram1_b_d),
  .en  (ram1_b_en),
  .we  (ram1_b_we),
