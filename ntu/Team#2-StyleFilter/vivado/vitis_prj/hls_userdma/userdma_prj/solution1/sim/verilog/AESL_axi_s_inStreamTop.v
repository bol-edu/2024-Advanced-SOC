...
module AESL_axi_s_inStreamTop (
    ...
    fifo #(1200, 32) fifo_inStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 4) fifo_inStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 4) fifo_inStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 7) fifo_inStreamTop_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 1) fifo_inStreamTop_TLAST (
        .reset(1'b0),
        .write_clock(clk),
