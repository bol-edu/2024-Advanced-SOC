...
module AESL_axi_s_outStreamTop (
    ...
    fifo #(1200, 32) fifo_outStreamTop_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 4) fifo_outStreamTop_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 4) fifo_outStreamTop_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 7) fifo_outStreamTop_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1200, 1) fifo_outStreamTop_TLAST (
        .reset(1'b0),
        .write_clock(clk),
