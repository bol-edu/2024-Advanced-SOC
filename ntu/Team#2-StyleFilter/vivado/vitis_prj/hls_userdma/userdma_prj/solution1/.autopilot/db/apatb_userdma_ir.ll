; ModuleID = '/home/ubuntu/Desktop/fsic_fpga/vivado/vitis_prj/hls_userdma/userdma_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_userdma_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias nonnull dereferenceable(12) %inStreamTop, i1* noalias nocapture nonnull %s2m_buf_sts, i1 zeroext %s2m_sts_clear, %"struct.ap_int<32>"* nocapture readonly %s2m_len, %"struct.ap_int<1>"* nocapture readonly %s2m_enb_clrsts, %"struct.ap_int<32>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="1200" %s2mbuf, i1* noalias nocapture nonnull %s2m_err, %"struct.ap_int<32>"* nocapture readonly %Img_width, %"struct.ap_int<32>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1200" %m2sbuf, i1* noalias nocapture nonnull %m2s_buf_sts, i1 zeroext %m2s_sts_clear, i32 %m2s_len, %"struct.ap_int<1>"* nocapture readonly %m2s_enb_clrsts, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias nonnull dereferenceable(12) %outStreamTop) local_unnamed_addr #0 {
entry:
  ...
  %malloccall = call i8* @malloc(i64 4800)
  %s2mbuf_copy = bitcast i8* %malloccall to [1200 x i32]*
  %s2m_err_copy = alloca i1, align 512
  %malloccall1 = call i8* @malloc(i64 4800)
  %m2sbuf_copy = bitcast i8* %malloccall1 to [1200 x i32]*
  ...
  %0 = bitcast %"struct.ap_int<32>"* %s2mbuf to [1200 x %"struct.ap_int<32>"]*
  %1 = bitcast %"struct.ap_int<32>"* %m2sbuf to [1200 x %"struct.ap_int<32>"]*
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* nonnull %inStreamTop, i32* %inStreamTop_copy.data, i4* %inStreamTop_copy.keep, i4* %inStreamTop_copy.strb, i7* %inStreamTop_copy.user, i1* %inStreamTop_copy.last, i1* nonnull %s2m_buf_sts, i1* nonnull align 512 %s2m_buf_sts_copy, [1200 x %"struct.ap_int<32>"]* nonnull %0, [1200 x i32]* %s2mbuf_copy, i1* nonnull %s2m_err, i1* nonnull align 512 %s2m_err_copy, [1200 x %"struct.ap_int<32>"]* nonnull %1, [1200 x i32]* %m2sbuf_copy, i1* nonnull %m2s_buf_sts, i1* nonnull align 512 %m2s_buf_sts_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* nonnull %outStreamTop, i32* %outStreamTop_copy.data, i4* %outStreamTop_copy.keep, i4* %outStreamTop_copy.strb, i7* %outStreamTop_copy.user, i1* %outStreamTop_copy.last)
  %2 = getelementptr [1200 x i32], [1200 x i32]* %s2mbuf_copy, i32 0, i32 0
  %3 = getelementptr [1200 x i32], [1200 x i32]* %m2sbuf_copy, i32 0, i32 0
  ...
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %inStreamTop, i32* %inStreamTop_copy.data, i4* %inStreamTop_copy.keep, i4* %inStreamTop_copy.strb, i7* %inStreamTop_copy.user, i1* %inStreamTop_copy.last, i1* %s2m_buf_sts, i1* %s2m_buf_sts_copy, [1200 x %"struct.ap_int<32>"]* %0, [1200 x i32]* %s2mbuf_copy, i1* %s2m_err, i1* %s2m_err_copy, [1200 x %"struct.ap_int<32>"]* %1, [1200 x i32]* %m2sbuf_copy, i1* %m2s_buf_sts, i1* %m2s_buf_sts_copy, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %outStreamTop, i32* %outStreamTop_copy.data, i4* %outStreamTop_copy.keep, i4* %outStreamTop_copy.strb, i7* %outStreamTop_copy.user, i1* %outStreamTop_copy.last)
...
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias readonly, i1* noalias align 512, [1200 x %"struct.ap_int<32>"]* noalias readonly, [1200 x i32]* noalias, i1* noalias readonly, i1* noalias align 512, [1200 x %"struct.ap_int<32>"]* noalias readonly, [1200 x i32]* noalias, i1* noalias readonly, i1* noalias align 512, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.2" %_V_strb_V3, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.4" %_V_last_V5) unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>.44"([1200 x i32]* %4, [1200 x %"struct.ap_int<32>"]* %3)
  call fastcc void @onebyonecpy_hls.p0i1(i1* align 512 %6, i1* %5)
  call fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>.44"([1200 x i32]* %8, [1200 x %"struct.ap_int<32>"]* %7)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias, i1* noalias readonly align 512, [1200 x %"struct.ap_int<32>"]* noalias, [1200 x i32]* noalias readonly, i1* noalias, i1* noalias readonly align 512, [1200 x %"struct.ap_int<32>"]* noalias, [1200 x i32]* noalias readonly, i1* noalias, i1* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.2" %_V_strb_V3, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.4" %_V_last_V5) unnamed_addr #3 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>"([1200 x %"struct.ap_int<32>"]* %3, [1200 x i32]* %4)
  call fastcc void @onebyonecpy_hls.p0i1(i1* %5, i1* align 512 %6)
  call fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>"([1200 x %"struct.ap_int<32>"]* %7, [1200 x i32]* %8)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>"([1200 x %"struct.ap_int<32>"]* noalias, [1200 x i32]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [1200 x %"struct.ap_int<32>"]* %0, null
  %3 = icmp eq [1200 x i32]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %5 = getelementptr [1200 x i32], [1200 x i32]* %1, i64 0, i64 %for.loop.idx7
  %dst.addr.0.0.06 = getelementptr [1200 x %"struct.ap_int<32>"], [1200 x %"struct.ap_int<32>"]* %0, i64 0, i64 %for.loop.idx7, i32 0, i32 0, i32 0
  %6 = load i32, i32* %5, align 4
  store i32 %6, i32* %dst.addr.0.0.06, align 4
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx7, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 1200
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>.44"([1200 x i32]* noalias, [1200 x %"struct.ap_int<32>"]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [1200 x i32]* %0, null
  %3 = icmp eq [1200 x %"struct.ap_int<32>"]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  %for.loop.idx7 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop ]
  %src.addr.0.0.05 = getelementptr [1200 x %"struct.ap_int<32>"], [1200 x %"struct.ap_int<32>"]* %1, i64 0, i64 %for.loop.idx7, i32 0, i32 0, i32 0
  %5 = getelementptr [1200 x i32], [1200 x i32]* %0, i64 0, i64 %for.loop.idx7
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias, i1* noalias readonly align 512, [1200 x %"struct.ap_int<32>"]* noalias, [1200 x i32]* noalias readonly, i1* noalias, i1* noalias readonly align 512, [1200 x %"struct.ap_int<32>"]* noalias, [1200 x i32]* noalias readonly, i1* noalias, i1* noalias readonly align 512, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* noalias, i32* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.0" %_V_data_V1, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.1" %_V_keep_V2, i4* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.2" %_V_strb_V3, i7* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="17.4" %_V_last_V5) unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %0, i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i7* %_V_user_V, i1* %_V_last_V)
  call fastcc void @onebyonecpy_hls.p0i1(i1* %1, i1* align 512 %2)
  call fastcc void @"onebyonecpy_hls.p0a1200struct.ap_int<32>"([1200 x %"struct.ap_int<32>"]* %3, [1200 x i32]* %4)
...
entry:
  ...
  %23 = bitcast i8* %malloccall to [1200 x %"struct.ap_int<32>"]*
  %malloccall1 = tail call i8* @malloc(i64 4800)
  %24 = bitcast i8* %malloccall1 to [1200 x %"struct.ap_int<32>"]*
  %25 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"
  %26 = bitcast i32* %9 to [1200 x i32]*
  %27 = bitcast i32* %12 to [1200 x i32]*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %22, i32* %0, i4* %1, i4* %2, i7* %3, i1* %4, i1* null, i1* %5, [1200 x %"struct.ap_int<32>"]* %23, [1200 x i32]* %26, i1* null, i1* %10, [1200 x %"struct.ap_int<32>"]* %24, [1200 x i32]* %27, i1* null, i1* %13, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %25, i32* %17, i4* %18, i4* %19, i7* %20, i1* %21)
  %28 = bitcast [1200 x %"struct.ap_int<32>"]* %23 to %"struct.ap_int<32>"*
  %29 = bitcast [1200 x %"struct.ap_int<32>"]* %24 to %"struct.ap_int<32>"*
  ...
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %22, i32* %0, i4* %1, i4* %2, i7* %3, i1* %4, i1* null, i1* %5, [1200 x %"struct.ap_int<32>"]* %23, [1200 x i32]* %26, i1* null, i1* %10, [1200 x %"struct.ap_int<32>"]* %24, [1200 x i32]* %27, i1* null, i1* %13, %"class.hls::stream<hls::axis<ap_uint<32>, 7, 0, 0>, 0>"* %25, i32* %17, i4* %18, i4* %19, i7* %20, i1* %21)
  ret void
}
