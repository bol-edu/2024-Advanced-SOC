...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_incount \
    op interface \
    ports { incount_dout { I 32 vector } incount_num_data_valid { I 3 vector } incount_fifo_cap { I 3 vector } incount_empty_n { I 1 bit } incount_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_en_clrsts_dout { I 1 vector } in_en_clrsts_num_data_valid { I 3 vector } in_en_clrsts_fifo_cap { I 3 vector } in_en_clrsts_empty_n { I 1 bit } in_en_clrsts_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in_s2m_len_dout { I 32 vector } in_s2m_len_num_data_valid { I 3 vector } in_s2m_len_fifo_cap { I 3 vector } in_s2m_len_empty_n { I 1 bit } in_s2m_len_read { O 1 bit } } \
} "
}
