        ...
        begin
            ...
            case (index1)
                ...
                1 : begin
                    case(index2)
                    2: begin
                        if (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127.inbuf_blk_n) begin
                        ...
                        if (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127.incount_blk_n) begin
                ...
                2 : begin
                    case(index2)
                    1: begin
                        if (~streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_21_2_fu_140.inbuf_blk_n) begin
                            if (~inbuf_U.if_empty_n) begin
                ...
                3 : begin
                    case(index2)
                    4: begin
                        if (~paralleltostreamwithburst_U0.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128.outbuf_blk_n) begin
                        ...
                        if (~start_for_sendoutstream_U0_U.if_full_n & paralleltostreamwithburst_U0.ap_start & ~paralleltostreamwithburst_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_sendoutstream_U0_U.if_read) begin
                ...
                4 : begin
                    case(index2)
                    3: begin
                        if (~sendoutstream_U0.grp_sendoutstream_Pipeline_VITIS_LOOP_128_1_fu_71.outbuf_blk_n) begin
                            if (~outbuf_U.if_empty_n) begin
                        ...
                        if (~start_for_sendoutstream_U0_U.if_empty_n & sendoutstream_U0.ap_idle & ~start_for_sendoutstream_U0_U.if_write) begin
                            $display("//      Blocked by missing 'ap_start' from start propagation FIFO 'userdma_userdma.start_for_sendoutstream_U0_U' written by process 'userdma_userdma.paralleltostreamwithburst_U0',");
                        end
                    end
                    1: begin
