...
architecture behav of userdma is 
    ...
    "userdma_userdma,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=12,HLS_SYN_DSP=0,HLS_SYN_FF=3850,HLS_SYN_LUT=5256,HLS_VERSION=2023_2}";
    ...
    signal endianness : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem1_RFIFONUM : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal getinstream_U0_s2m_err : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal paralleltostreamwithburst_U0_start_out : STD_LOGIC;
    signal paralleltostreamwithburst_U0_start_write : STD_LOGIC;
    ...
    signal inbuf_num_data_valid : STD_LOGIC_VECTOR (6 downto 0);
    signal inbuf_fifo_cap : STD_LOGIC_VECTOR (6 downto 0);
    signal inbuf_empty_n : STD_LOGIC;
    signal incount_full_n : STD_LOGIC;
    signal incount_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal incount_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal incount_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal incount_empty_n : STD_LOGIC;
    signal s2m_len_c_full_n : STD_LOGIC;
    signal s2m_len_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal s2m_len_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal s2m_len_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal s2m_enb_clrsts_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal s2m_enb_clrsts_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal s2m_enb_clrsts_c_empty_n : STD_LOGIC;
    signal outbuf_full_n : STD_LOGIC;
    signal outbuf_dout : STD_LOGIC_VECTOR (32 downto 0);
    signal outbuf_num_data_valid : STD_LOGIC_VECTOR (6 downto 0);
    signal outbuf_fifo_cap : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal m2s_enb_clrsts_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal m2s_enb_clrsts_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    component userdma_fifo_w33_d64_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component userdma_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    inbuf_U : component userdma_fifo_w33_d64_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    incount_U : component userdma_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    outbuf_U : component userdma_fifo_w33_d64_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
