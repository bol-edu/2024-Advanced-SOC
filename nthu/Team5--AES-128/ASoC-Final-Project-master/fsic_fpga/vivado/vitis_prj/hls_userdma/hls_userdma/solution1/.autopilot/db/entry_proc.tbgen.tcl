...
set Spec2ImplPortList { 
	...
	s2mbuf_c { ap_fifo {  { s2mbuf_c_din fifo_data_in 1 64 }  { s2mbuf_c_num_data_valid fifo_status_num_data_valid 0 3 }  { s2mbuf_c_fifo_cap fifo_update 0 3 }  { s2mbuf_c_full_n fifo_status 0 1 }  { s2mbuf_c_write fifo_port_we 1 1 } } }
}
