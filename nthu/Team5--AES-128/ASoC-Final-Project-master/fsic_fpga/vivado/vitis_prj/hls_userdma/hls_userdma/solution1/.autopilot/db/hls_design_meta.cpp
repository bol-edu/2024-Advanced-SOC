...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("outStreamTop_TDATA", 32, hls_out, 16, "axis", "out_data", 1),
	Port_Property("outStreamTop_TKEEP", 4, hls_out, 17, "axis", "out_data", 1),
	Port_Property("outStreamTop_TSTRB", 4, hls_out, 18, "axis", "out_data", 1),
	Port_Property("outStreamTop_TUSER", 7, hls_out, 19, "axis", "out_data", 1),
	Port_Property("outStreamTop_TLAST", 1, hls_out, 20, "axis", "out_data", 1),
	Port_Property("inStreamTop_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("inStreamTop_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("outStreamTop_TVALID", 1, hls_out, 20, "axis", "out_vld", 1),
	Port_Property("outStreamTop_TREADY", 1, hls_in, 20, "axis", "out_acc", 1),
};
