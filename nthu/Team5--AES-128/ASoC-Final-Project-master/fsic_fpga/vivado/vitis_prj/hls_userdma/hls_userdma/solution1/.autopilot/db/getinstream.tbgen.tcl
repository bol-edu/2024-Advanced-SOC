...
set C_modelArgMapList {[ 
	{ "Name" : "inStreamTop_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "endianness", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s2m_err sc_out sc_lv 2 signal 7 } 
	{ s2m_err_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ inbuf_din sc_out sc_lv 33 signal 8 } 
	{ inbuf_num_data_valid sc_in sc_lv 7 signal 8 } 
	...
	{ incount_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ incount_fifo_cap sc_in sc_lv 3 signal 9 } 
	{ incount_full_n sc_in sc_logic 1 signal 9 } 
	{ incount_write sc_out sc_logic 1 signal 9 } 
	{ endianness sc_in sc_lv 1 signal 10 } 
	{ s2m_len_c_din sc_out sc_lv 32 signal 11 } 
	{ s2m_len_c_num_data_valid sc_in sc_lv 3 signal 11 } 
	{ s2m_len_c_fifo_cap sc_in sc_lv 3 signal 11 } 
	...
	{ s2m_enb_clrsts_c_num_data_valid sc_in sc_lv 3 signal 12 } 
	{ s2m_enb_clrsts_c_fifo_cap sc_in sc_lv 3 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "endianness", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "endianness", "role": "default" }} , 
 	{ "name": "s2m_len_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "din" }} , 
 	{ "name": "s2m_len_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "num_data_valid" }} , 
 	{ "name": "s2m_len_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s2m_len_c", "role": "fifo_cap" }} , 
 	...
 	{ "name": "s2m_enb_clrsts_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s2m_enb_clrsts_c", "role": "num_data_valid" }} , 
 	{ "name": "s2m_enb_clrsts_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "s2m_enb_clrsts_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "inStreamTop_V_data_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inStreamTop_V_data_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_keep_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inStreamTop_V_keep_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_strb_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inStreamTop_V_strb_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_user_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inStreamTop_V_user_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "inStreamTop_V_last_V", "Type" : "Axis", "Direction" : "I", "BaseName" : "inStreamTop",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inStreamTop_V_last_V", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			...
			{"Name" : "inbuf", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "inbuf", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "incount", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Port" : "incount", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
...
set Spec2ImplPortList { 
	...
	inbuf { ap_fifo {  { inbuf_din fifo_data_in 1 33 }  { inbuf_num_data_valid fifo_status_num_data_valid 0 7 }  { inbuf_fifo_cap fifo_update 0 7 }  { inbuf_full_n fifo_status 0 1 }  { inbuf_write fifo_port_we 1 1 } } }
	incount { ap_fifo {  { incount_din fifo_data_in 1 32 }  { incount_num_data_valid fifo_status_num_data_valid 0 3 }  { incount_fifo_cap fifo_update 0 3 }  { incount_full_n fifo_status 0 1 }  { incount_write fifo_port_we 1 1 } } }
	endianness { ap_none {  { endianness in_data 0 1 } } }
	s2m_len_c { ap_fifo {  { s2m_len_c_din fifo_data_in 1 32 }  { s2m_len_c_num_data_valid fifo_status_num_data_valid 0 3 }  { s2m_len_c_fifo_cap fifo_update 0 3 }  { s2m_len_c_full_n fifo_status 0 1 }  { s2m_len_c_write fifo_port_we 1 1 } } }
	s2m_enb_clrsts_c { ap_fifo {  { s2m_enb_clrsts_c_din fifo_data_in 1 1 }  { s2m_enb_clrsts_c_num_data_valid fifo_status_num_data_valid 0 3 }  { s2m_enb_clrsts_c_fifo_cap fifo_update 0 3 }  { s2m_enb_clrsts_c_full_n fifo_status 0 1 }  { s2m_enb_clrsts_c_write fifo_port_we 1 1 } } }
}
