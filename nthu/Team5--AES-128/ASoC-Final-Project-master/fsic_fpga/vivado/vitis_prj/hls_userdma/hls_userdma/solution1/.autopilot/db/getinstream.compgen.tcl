...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_incount \
    op interface \
    ports { incount_din { O 32 vector } incount_num_data_valid { I 3 vector } incount_fifo_cap { I 3 vector } incount_full_n { I 1 bit } incount_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_endianness \
    op interface \
    ports { endianness { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s2m_len_c_din { O 32 vector } s2m_len_c_num_data_valid { I 3 vector } s2m_len_c_fifo_cap { I 3 vector } s2m_len_c_full_n { I 1 bit } s2m_len_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s2m_enb_clrsts_c_din { O 1 vector } s2m_enb_clrsts_c_num_data_valid { I 3 vector } s2m_enb_clrsts_c_fifo_cap { I 3 vector } s2m_enb_clrsts_c_full_n { I 1 bit } s2m_enb_clrsts_c_write { O 1 bit } } \
} "
}
