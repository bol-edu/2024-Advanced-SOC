...
set portList { 
	...
	{ m_axi_gmem1_RFIFONUM sc_in sc_lv 7 signal 0 } 
	...
	{ in_m2s_len sc_in sc_lv 32 signal 3 } 
	{ outbuf_din sc_out sc_lv 33 signal 4 } 
	{ outbuf_num_data_valid sc_in sc_lv 7 signal 4 } 
	{ outbuf_fifo_cap sc_in sc_lv 7 signal 4 } 
	{ outbuf_full_n sc_in sc_logic 1 signal 4 } 
	{ outbuf_write sc_out sc_logic 1 signal 4 } 
	{ endianness sc_in sc_lv 1 signal 5 } 
	{ m2s_enb_clrsts_c_din sc_out sc_lv 1 signal 6 } 
	{ m2s_enb_clrsts_c_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ m2s_enb_clrsts_c_fifo_cap sc_in sc_lv 3 signal 6 } 
	{ m2s_enb_clrsts_c_full_n sc_in sc_logic 1 signal 6 } 
	{ m2s_enb_clrsts_c_write sc_out sc_logic 1 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_gmem1_RFIFONUM", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "gmem1", "role": "RFIFONUM" }} , 
 	...
 	{ "name": "m2s_enb_clrsts_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "num_data_valid" }} , 
 	{ "name": "m2s_enb_clrsts_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "m2s_enb_clrsts_c", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem1", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128", "Port" : "gmem1", "Inst_start_state" : "20", "Inst_end_state" : "21"}]},
			...
			{"Name" : "outbuf", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128", "Port" : "outbuf", "Inst_start_state" : "20", "Inst_end_state" : "21"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	outbuf { ap_fifo {  { outbuf_din fifo_data_in 1 33 }  { outbuf_num_data_valid fifo_status_num_data_valid 0 7 }  { outbuf_fifo_cap fifo_update 0 7 }  { outbuf_full_n fifo_status 0 1 }  { outbuf_write fifo_port_we 1 1 } } }
	endianness { ap_none {  { endianness in_data 0 1 } } }
	m2s_enb_clrsts_c { ap_fifo {  { m2s_enb_clrsts_c_din fifo_data_in 1 1 }  { m2s_enb_clrsts_c_num_data_valid fifo_status_num_data_valid 0 3 }  { m2s_enb_clrsts_c_fifo_cap fifo_update 0 3 }  { m2s_enb_clrsts_c_full_n fifo_status 0 1 }  { m2s_enb_clrsts_c_write fifo_port_we 1 1 } } }
}
