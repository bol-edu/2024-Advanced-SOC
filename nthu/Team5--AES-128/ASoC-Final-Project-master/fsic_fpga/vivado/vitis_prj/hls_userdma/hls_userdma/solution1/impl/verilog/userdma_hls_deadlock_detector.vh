...
reg [15:0] trans_in_cnt_1;// for process paralleltostreamwithburst_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_1 <= 16'h0;
    end
    else if (paralleltostreamwithburst_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_1;// for process paralleltostreamwithburst_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_1 <= 16'h0;
    end
    else if (paralleltostreamwithburst_U0.ap_done == 1'b1 && paralleltostreamwithburst_U0.ap_continue == 1'b1) begin
    ...
    userdma_hls_deadlock_detect_unit #(5, 0, 3, 3) userdma_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.s2mbuf_c_blk_n);
    ...
    assign proc_0_input_sync_blk[1] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_getinstream_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_entry_proc_U0_ap_ready & entry_proc_U0.ap_idle & ~ap_sync_paralleltostreamwithburst_U0_ap_ready);
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127.inbuf_blk_n) | (~getinstream_U0.grp_getinstream_Pipeline_VITIS_LOOP_49_1_fu_127.incount_blk_n) | (~getinstream_U0.s2m_len_c_blk_n) | (~getinstream_U0.s2m_enb_clrsts_c_blk_n);
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~streamtoparallelwithburst_U0.grp_streamtoparallelwithburst_Pipeline_VITIS_LOOP_21_2_fu_140.inbuf_blk_n) | (~streamtoparallelwithburst_U0.incount_blk_n) | (~streamtoparallelwithburst_U0.in_en_clrsts_blk_n) | (~streamtoparallelwithburst_U0.in_s2m_len_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~streamtoparallelwithburst_U0.out_memory_blk_n);
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~paralleltostreamwithburst_U0.grp_paralleltostreamwithburst_Pipeline_VITIS_LOOP_100_2_fu_128.outbuf_blk_n) | (~paralleltostreamwithburst_U0.m2s_enb_clrsts_c_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_sendoutstream_U0_U.if_full_n & paralleltostreamwithburst_U0.ap_start & ~paralleltostreamwithburst_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_sendoutstream_U0_U.if_read);
    ...
    userdma_hls_deadlock_detect_unit #(5, 4, 3, 3) userdma_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~sendoutstream_U0.grp_sendoutstream_Pipeline_VITIS_LOOP_128_1_fu_71.outbuf_blk_n) | (~sendoutstream_U0.in_en_clrsts_blk_n);
    assign proc_4_data_PIPO_blk[0] = 1'b0;
    assign proc_4_start_FIFO_blk[0] = 1'b0 | (~start_for_sendoutstream_U0_U.if_empty_n & sendoutstream_U0.ap_idle & ~start_for_sendoutstream_U0_U.if_write);
    ...
    assign proc_4_output_sync_blk[1] = 1'b0 | (ap_done_reg_2 & sendoutstream_U0.ap_done & ~getinstream_U0.ap_done);
    ...
    assign proc_4_output_sync_blk[2] = 1'b0 | (ap_done_reg_2 & sendoutstream_U0.ap_done & ~streamtoparallelwithburst_U0.ap_done);
