...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/user_subsys/user_prj/user_prj0/rtl/concat_rtl_less_lat.v"]"\
...
# caravel, ps_axil, spiflash
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
CONFIG.Coe_File {/home/ubuntu/final_fpga/vivado/fsic.coe} \
