...
typedef
    ccs_design::HDL::EdgeDetect_IP::EdgeDetect_VerDer ccs_DUT_wrapper;
...
public:
  ...
  sc_out<sc_lv<8> > dat_out_rsc_dat;
  sc_out<sc_logic> dat_out_rsc_vld;
  sc_in<sc_logic> dat_out_rsc_rdy;
  sc_out<sc_lv<9> > dy_rsc_dat;
  sc_out<sc_logic> dy_rsc_vld;
  sc_in<sc_logic> dy_rsc_rdy;
