...
#define TOP_HDL_ENTITY EdgeDetect_IP_EdgeDetect_VerDer
#endif
...
public:
  ...
  sc_signal<sc_lv<8> >                                    TLS_dat_out_rsc_dat;
  sc_signal<sc_logic>                                     TLS_dat_out_rsc_vld;
  sc_signal<sc_logic>                                     TLS_dat_out_rsc_rdy;
  sc_signal<sc_lv<9> >                                    TLS_dy_rsc_dat;
  sc_signal<sc_logic>                                     TLS_dy_rsc_vld;
  sc_signal<sc_logic>                                     TLS_dy_rsc_rdy;
  ...
  ccs_DUT_wrapper                                         EdgeDetect_IP_EdgeDetect_VerDer_INST;
  ccs_in_wait_coupled_trans_rsc_v1<1,8 >                  dat_in_rsc_INST;
  ccs_out_wait_trans_rsc_v1<1,8 >                         dat_out_rsc_INST;
  ccs_out_wait_trans_rsc_v1<1,9 >                         dy_rsc_INST;
  ...
  tlm::tlm_fifo<ac_int<8, false > >                       TLS_out_fifo_dat_out;
  tlm::tlm_fifo<mc_wait_ctrl>                             TLS_out_wait_ctrl_fifo_dat_out;
  sc_signal<sc_logic>                                     TLS_dat_out_rsc_trdone;
  mc_output_transactor<ac_int<8, false >,8,false>         transactor_dat_out;
  tlm::tlm_fifo<ac_int<9, true > >                        TLS_out_fifo_dy;
  tlm::tlm_fifo<mc_wait_ctrl>                             TLS_out_wait_ctrl_fifo_dy;
  sc_signal<sc_logic>                                     TLS_dy_rsc_trdone;
  mc_output_transactor<ac_int<9, true >,9,true>           transactor_dy;
  ...
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst_run_wen;
  sc_signal<sc_logic>                                     OFS_dat_in_rsc_vld;
  sc_signal<sc_logic>                                     OFS_dat_out_rsc_rdy;
  sc_signal<sc_logic>                                     OFS_dy_rsc_rdy;
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_dat_in_wait_ctrl_inst_dat_in_rsci_irdy_run_sct;
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst_dat_out_rsci_irdy;
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst_dat_out_rsci_ivld_run_sct;
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst_dy_rsci_irdy;
  sc_signal<sc_logic>                                     OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst_dy_rsci_ivld_run_sct;
  ...
  void drive_TLS_dat_out_rsc_trdone();
  void drive_TLS_dy_rsc_trdone();
  ...
  scverify_top(const sc_module_name& name)
    ...
    , TLS_dat_out_rsc_dat("TLS_dat_out_rsc_dat")
    , TLS_dat_out_rsc_vld("TLS_dat_out_rsc_vld")
    , TLS_dat_out_rsc_rdy("TLS_dat_out_rsc_rdy")
    , TLS_dy_rsc_dat("TLS_dy_rsc_dat")
    , TLS_dy_rsc_vld("TLS_dy_rsc_vld")
    , TLS_dy_rsc_rdy("TLS_dy_rsc_rdy")
    ...
    , EdgeDetect_IP_EdgeDetect_VerDer_INST("rtl", TO_QUOTED_STRING(TOP_HDL_ENTITY))
    , dat_in_rsc_INST("dat_in_rsc", true)
    , dat_out_rsc_INST("dat_out_rsc", true)
    , dy_rsc_INST("dy_rsc", true)
    ...
    , TLS_out_fifo_dat_out("TLS_out_fifo_dat_out", -1)
    , TLS_out_wait_ctrl_fifo_dat_out("TLS_out_wait_ctrl_fifo_dat_out", -1)
    , TLS_dat_out_rsc_trdone("TLS_dat_out_rsc_trdone")
    , transactor_dat_out("transactor_dat_out", 0, 8, 0)
    , TLS_out_fifo_dy("TLS_out_fifo_dy", -1)
    , TLS_out_wait_ctrl_fifo_dy("TLS_out_wait_ctrl_fifo_dy", -1)
    , TLS_dy_rsc_trdone("TLS_dy_rsc_trdone")
    , transactor_dy("transactor_dy", 0, 9, 0)
    ...
    , catapult_monitor_INST("Monitor", clk, true, 7LL, 7LL)
    ...
    , var_trdone(false)
  {
    ...
    EdgeDetect_IP_EdgeDetect_VerDer_INST.clk(clk);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.rst(TLS_rst);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.arst_n(TLS_arst_n);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_in_rsc_dat(TLS_dat_in_rsc_dat);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_in_rsc_vld(TLS_dat_in_rsc_vld);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_in_rsc_rdy(TLS_dat_in_rsc_rdy);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.widthIn(TLS_widthIn);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.heightIn(TLS_heightIn);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_out_rsc_dat(TLS_dat_out_rsc_dat);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_out_rsc_vld(TLS_dat_out_rsc_vld);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dat_out_rsc_rdy(TLS_dat_out_rsc_rdy);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dy_rsc_dat(TLS_dy_rsc_dat);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dy_rsc_vld(TLS_dy_rsc_vld);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.dy_rsc_rdy(TLS_dy_rsc_rdy);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf0_rsc_en(TLS_line_buf0_rsc_en);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf0_rsc_q(TLS_line_buf0_rsc_q);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf0_rsc_we(TLS_line_buf0_rsc_we);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf0_rsc_d(TLS_line_buf0_rsc_d);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf0_rsc_adr(TLS_line_buf0_rsc_adr);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf1_rsc_en(TLS_line_buf1_rsc_en);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf1_rsc_q(TLS_line_buf1_rsc_q);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf1_rsc_we(TLS_line_buf1_rsc_we);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf1_rsc_d(TLS_line_buf1_rsc_d);
    EdgeDetect_IP_EdgeDetect_VerDer_INST.line_buf1_rsc_adr(TLS_line_buf1_rsc_adr);
    ...
    dat_out_rsc_INST.rdy(TLS_dat_out_rsc_rdy);
    dat_out_rsc_INST.vld(TLS_dat_out_rsc_vld);
    dat_out_rsc_INST.dat(TLS_dat_out_rsc_dat);
    dat_out_rsc_INST.clk(clk);
    dat_out_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_4)));

    dy_rsc_INST.rdy(TLS_dy_rsc_rdy);
    dy_rsc_INST.vld(TLS_dy_rsc_vld);
    dy_rsc_INST.dat(TLS_dy_rsc_dat);
    dy_rsc_INST.clk(clk);
    dy_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_5)));
    ...
    line_buf0_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_6)));
    ...
    line_buf1_rsc_INST.add_attribute(*(new sc_attribute<double>("CLK_SKEW_DELAY", __scv_hold_time_RSCID_7)));
    ...
    transactor_dat_out.out_fifo(TLS_out_fifo_dat_out);
    transactor_dat_out.out_wait_ctrl_fifo(TLS_out_wait_ctrl_fifo_dat_out);
    transactor_dat_out.bind_clk(clk, true, rst);
    transactor_dat_out.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_dat_out.register_block(&dat_out_rsc_INST, dat_out_rsc_INST.basename(), TLS_dat_out_rsc_trdone, 0, 0, 1);

    transactor_dy.out_fifo(TLS_out_fifo_dy);
    transactor_dy.out_wait_ctrl_fifo(TLS_out_wait_ctrl_fifo_dy);
    transactor_dy.bind_clk(clk, true, rst);
    transactor_dy.add_attribute(*(new sc_attribute<int>("MC_TRANSACTOR_EVENT", 0 )));
    transactor_dy.register_block(&dy_rsc_INST, dy_rsc_INST.basename(), TLS_dy_rsc_trdone, 0, 0, 1);
    ...
    testbench_INST.ccs_dat_out(TLS_out_fifo_dat_out);
    testbench_INST.ccs_wait_ctrl_dat_out(TLS_out_wait_ctrl_fifo_dat_out);
    testbench_INST.ccs_dy(TLS_out_fifo_dy);
    testbench_INST.ccs_wait_ctrl_dy(TLS_out_wait_ctrl_fifo_dy);
    ...
    SC_METHOD(drive_TLS_dat_out_rsc_trdone);
      sensitive << TLS_dat_out_rsc_vld;
      sensitive << TLS_dat_out_rsc_rdy;

    SC_METHOD(drive_TLS_dy_rsc_trdone);
      sensitive << TLS_dy_rsc_vld;
      sensitive << TLS_dy_rsc_rdy;
    ...
    SC_METHOD(deadlock_watch);
      sensitive << clk;
      sensitive << OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst_run_wen;
      dont_initialize();
...
void scverify_top::drive_TLS_dat_out_rsc_trdone() {
  TLS_dat_out_rsc_trdone.write(TLS_dat_out_rsc_vld.read() & TLS_dat_out_rsc_rdy.read());
}

void scverify_top::drive_TLS_dy_rsc_trdone() {
  TLS_dy_rsc_trdone.write(TLS_dy_rsc_vld.read() & TLS_dy_rsc_rdy.read());
}
...
void scverify_top::setup_autowait() {
  ...
  transactor_dat_out.set_auto_wait_limit(env_SCVerify_AUTOWAIT);
  transactor_dat_out.configure_autowait(autowait_output_cfg);
  transactor_dy.set_auto_wait_limit(env_SCVerify_AUTOWAIT);
  transactor_dy.configure_autowait(autowait_output_cfg);
...
void scverify_top::inform_autowait() {
  ...
  waited |= (transactor_dat_out.atleast_one_autowait(1) > 0);
  waited |= (transactor_dy.atleast_one_autowait(1) > 0);
...
void scverify_top::setup_debug() {
  ...
  static int transactor_dat_out_flags = MC_DEFAULT_TRANSACTOR_LOG;
  static int transactor_dy_flags = MC_DEFAULT_TRANSACTOR_LOG;
  ...
  static int transactor_dat_out_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_dy_flags = MC_TRANSACTOR_UNDERFLOW | MC_TRANSACTOR_WAIT;
  static int transactor_widthIn_flags = 0;
  static int transactor_heightIn_flags = 0;
#endif
  static int transactor_dat_in_count = -1;
  static int transactor_dat_out_count = -1;
  static int transactor_dy_count = -1;
  ...
  if (debug_cmds.is_open()) {
    ...
    debug("transactor_dat_out",transactor_dat_out_flags,transactor_dat_out_count);
    debug("transactor_dy",transactor_dy_flags,transactor_dy_count);
...
void scverify_top::debug(const char* varname, int flags, int count) {
  ...
  if (strcmp(varname,"transactor_dat_out") == 0)
    xlator_p = &transactor_dat_out;
  if (strcmp(varname,"transactor_dy") == 0)
    xlator_p = &transactor_dy;
...
void scverify_top::generate_reset() {
  ...
  if (activate_reset || sc_time_stamp() == SC_ZERO_TIME) {
    ...
    if (toggle_hw_reset) {
      ...
      transactor_dat_out.reset_streams();
      transactor_dy.reset_streams();
...
void scverify_top::install_observe_foreign_signals() {
  ...
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst_run_wen, /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst/run_wen);
  OBSERVE_FOREIGN_SIGNAL(OFS_dat_in_rsc_vld, /scverify_top/rtl/dat_in_rsc_vld);
  OBSERVE_FOREIGN_SIGNAL(OFS_dat_out_rsc_rdy, /scverify_top/rtl/dat_out_rsc_rdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_dy_rsc_rdy, /scverify_top/rtl/dy_rsc_rdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_dat_in_wait_ctrl_inst_dat_in_rsci_irdy_run_sct,
      /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_in_rsci_dat_in_wait_ctrl_inst/dat_in_rsci_irdy_run_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst_dat_out_rsci_irdy,
      /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst/dat_out_rsci_irdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst_dat_out_rsci_ivld_run_sct,
      /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dat_out_rsci_dat_out_wait_ctrl_inst/dat_out_rsci_ivld_run_sct);
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst_dy_rsci_irdy,
      /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst/dy_rsci_irdy);
  OBSERVE_FOREIGN_SIGNAL(OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst_dy_rsci_ivld_run_sct,
      /scverify_top/rtl/EdgeDetect_IP_EdgeDetect_VerDer_run_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_inst/EdgeDetect_IP_EdgeDetect_VerDer_run_dy_rsci_dy_wait_ctrl_inst/dy_rsci_ivld_run_sct);
#endif
#endif
}
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      (OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst_run_wen.read() == SC_LOGIC_0)
      && (OFS_dat_in_rsc_vld.read() == SC_LOGIC_1)
      && (OFS_dat_out_rsc_rdy.read() == SC_LOGIC_1)
      && (OFS_dy_rsc_rdy.read() == SC_LOGIC_1)
    ) {
...
#if defined(MTI_SYSTEMC) || defined(NCSC) || defined(VCS_SYSTEMC)
  bool X = (OFS_EdgeDetect_IP_EdgeDetect_VerDer_run_inst_EdgeDetect_IP_EdgeDetect_VerDer_run_staller_inst_run_wen.read()==0);
  bool Y = false;
  var_trdone = X || Y;
