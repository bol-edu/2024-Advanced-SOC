...
public:
   ...
   mc_comparator< ac_int<9, true > , MaskPacket< 1, 9 > > *dx_comp;
   ...
   sc_port< tlm::tlm_fifo_get_if< ac_int<9, true > > > ccs_dx;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_dx;
   ...
   unsigned int remaining_dx_golden;
   tlm::tlm_fifo< mc_golden_info< ac_int<9, true >, MaskPacket<1, 9> > > dx_golden;
   bool _capture_dx;
   int dx_capture_count;
   int dx_iteration_count;
   ac_channel<ac_int<9, true > > * dx_pointer;
   bool dx_pointer_set;
   int wait_cnt;
   ...
   mc_testbench(
      ...
      , ccs_dx("ccs_dx")
      , ccs_wait_ctrl_dx("ccs_wait_ctrl_dx")
      ...
      , remaining_dx_golden(0)
      , dx_golden("dx_golden",-1)
   {
      // Instantiate other modules
      dx_comp = new mc_comparator< ac_int<9, true > , MaskPacket< 1, 9 > > (
         "dx_comp",
         "dx",
         1,
      ...
      dx_comp->data_in(ccs_dx);
      dx_comp->data_golden(dx_golden);
   ...
   public:
      void capture_dx( ac_channel<ac_int<9, true > > &dx) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, true> > &dx) ;
   public:
      static void capture_OUT(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, true> > &dx) ;
   public:
      static void exec_run(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, true> > &dx) ;
   protected:
