...
class testbench
{
   ...
   static bool dx_ignore;
   static bool dx_skip;
   static bool dx_skip_quiet;
   static bool dx_skip_once;
   static bool dx_skip_noerr;
   static int  dx_array_comp_first;
   static int  dx_array_comp_last;
   static bool dx_use_mask;
   static ac_int<9, true > dx_output_mask;
   static mc_wait_ctrl dx_wait_ctrl;
...
extern void mc_testbench_dx_skip(bool v);
