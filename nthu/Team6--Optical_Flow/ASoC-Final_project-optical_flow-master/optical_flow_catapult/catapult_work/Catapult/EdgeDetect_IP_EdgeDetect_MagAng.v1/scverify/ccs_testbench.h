...
class testbench
{
   ...
   static bool dx_in_ignore;
   static bool dx_in_skip;
   static bool dx_in_skip_quiet;
   static bool dx_in_skip_once;
   static bool dx_in_skip_noerr;
   static int  dx_in_array_comp_first;
   static int  dx_in_array_comp_last;
   static mc_wait_ctrl dx_in_wait_ctrl;
   static bool dy_in_ignore;
   static bool dy_in_skip;
   static bool dy_in_skip_quiet;
   static bool dy_in_skip_once;
   static bool dy_in_skip_noerr;
   static int  dy_in_array_comp_first;
   static int  dy_in_array_comp_last;
   static mc_wait_ctrl dy_in_wait_ctrl;
...
extern void mc_testbench_dx_in_skip(bool v);
extern void mc_testbench_dy_in_skip(bool v);
