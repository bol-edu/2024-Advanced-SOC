...
void testbench::exec_run(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, false> > &magn, ac_channel<ac_fixed<8, 3, true, AC_TRN, AC_WRAP> > &angle) {
   return mc_testbench::exec_run(dat_in, widthIn, heightIn, magn, angle);
}
#endif
...
void mc_testbench::capture_IN(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, false> > &magn, ac_channel<ac_fixed<8, 3, true, AC_TRN, AC_WRAP> > &angle)
{
...
void mc_testbench::capture_OUT(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, false> > &magn, ac_channel<ac_fixed<8, 3, true, AC_TRN, AC_WRAP> > &angle)
{
...
void mc_testbench::exec_run(ac_channel<ac_int<8, false> > &dat_in, ac_int<11, false> &widthIn, ac_int<10, false> &heightIn, ac_channel<ac_int<9, false> > &magn, ac_channel<ac_fixed<8, 3, true, AC_TRN, AC_WRAP> > &angle)
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   wait_for_idle_sync();
   capture_IN(dat_in, widthIn, heightIn, magn, angle);
   EdgeDetect_IP::EdgeDetect_Top::run(dat_in, widthIn, heightIn, magn, angle);
   ...
   capture_OUT(dat_in, widthIn, heightIn, magn, angle);
   #else
   #endif
}
// ============================================
