...
# Generated date: Mon Feb 26 23:43:57 CST 2024
#
# ----------------------------------------------------------------------------
# ===================================================
...
RTL_NETLIST_FNAME           = /home/m111/m111061545/catapult/catapult-for-soc-course/lab2_edgedetec_fsic/01_edgedetect/catapult_work/Catapult/EdgeDetect_IP_EdgeDetect_Top.v1/concat_sim_rtl.v
endif
...
$(TARGET)/$(notdir $(GATE_VHDL_DEP)): DUT_E=EdgeDetect_IP_EdgeDetect_Top
endif
ifneq ($(GATE_VLOG_DEP),)
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): HDL_LIB=work
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): VLOG_TOP=1
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): DUT_E=my_func
$(TARGET)/$(notdir $(GATE_VLOG_DEP)): DUT_E=EdgeDetect_IP_EdgeDetect_Top
endif
endif
# 
...
$(TARGET)/concat_sim_rtl.v.vts: DUT_E=EdgeDetect_IP_EdgeDetect_Top
