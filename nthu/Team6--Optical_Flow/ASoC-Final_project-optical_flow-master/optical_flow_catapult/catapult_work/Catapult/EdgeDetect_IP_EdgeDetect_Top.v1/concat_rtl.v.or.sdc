...
set data_inputs [list dat_in_rsc_vld {dat_in_rsc_dat[*]} magn_rsc_rdy angle_rsc_rdy {widthIn[*]} {heightIn[*]} {line_buf0_rsc_q[*]} {line_buf1_rsc_q[*]}]
...
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf0_rsc_en}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf0_rsc_q[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf0_rsc_we}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf0_rsc_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf0_rsc_adr[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf1_rsc_en}]
set_input_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf1_rsc_q[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf1_rsc_we}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf1_rsc_d[*]}]
set_output_delay -clock [get_clocks {clk}] 0.0 [get_ports {line_buf1_rsc_adr[*]}]
