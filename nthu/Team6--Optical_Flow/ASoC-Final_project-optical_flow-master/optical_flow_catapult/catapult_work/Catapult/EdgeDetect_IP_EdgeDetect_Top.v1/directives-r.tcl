...
##############################################################################
#
# Solution: EdgeDetect_IP::EdgeDetect_HorDer.v1
#
# Catapult Ultra Synthesis 2023.1/1033555 (Production Release) Mon Feb 13 11:32:25 PST 2023
#
solution new -state initial -version v1 EdgeDetect_IP::EdgeDetect_HorDer
...
##############################################################################
#
# Solution: EdgeDetect_IP::EdgeDetect_MagAng.v1
#
# Catapult Ultra Synthesis 2023.1/1033555 (Production Release) Mon Feb 13 11:32:25 PST 2023
#
solution new -state initial -version v1 EdgeDetect_IP::EdgeDetect_MagAng
solution options defaults
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath {../hls_c/inc ../cmodel/inc ../bmpUtil/inc}
solution options set /Output/OutputVHDL false
...
##############################################################################
#
# Solution: EdgeDetect_IP::EdgeDetect_VerDer.v1
#
# Catapult Ultra Synthesis 2023.1/1033555 (Production Release) Mon Feb 13 11:32:25 PST 2023
#
solution new -state initial -version v1 EdgeDetect_IP::EdgeDetect_VerDer
solution options defaults
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath {../hls_c/inc ../cmodel/inc ../bmpUtil/inc}
solution options set /Output/OutputVHDL false
...
##############################################################################
#
# Solution: EdgeDetect_IP::EdgeDetect_Top.v1
#
# Catapult Ultra Synthesis 2023.1/1033555 (Production Release) Mon Feb 13 11:32:25 PST 2023
#
solution new -state initial -version v1 EdgeDetect_IP::EdgeDetect_Top
solution options defaults
solution options set /Input/TargetPlatform x86_64
solution options set /Input/SearchPath {../hls_c/inc ../cmodel/inc ../bmpUtil/inc}
solution options set /Output/OutputVHDL false
