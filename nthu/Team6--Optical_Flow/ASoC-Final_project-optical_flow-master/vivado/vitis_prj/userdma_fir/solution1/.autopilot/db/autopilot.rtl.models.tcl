set SynModuleInfo {
  ...
  {SRCNAME getinstream_Pipeline_VITIS_LOOP_50_1 MODELNAME getinstream_Pipeline_VITIS_LOOP_50_1 RTLNAME userdma_getinstream_Pipeline_VITIS_LOOP_50_1
    SUBMODULES {
  ...
  {SRCNAME userdma MODELNAME userdma RTLNAME userdma IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME userdma_fifo_w33_d1024_A RTLNAME userdma_fifo_w33_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      ...
      {MODELNAME userdma_fifo_w40_d1024_A RTLNAME userdma_fifo_w40_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
