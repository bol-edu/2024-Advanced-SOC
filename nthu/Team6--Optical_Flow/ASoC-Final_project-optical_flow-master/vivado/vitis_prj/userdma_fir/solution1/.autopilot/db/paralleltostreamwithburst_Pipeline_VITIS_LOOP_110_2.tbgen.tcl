set moduleName paralleltostreamwithburst_Pipeline_VITIS_LOOP_110_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {paralleltostreamwithburst_Pipeline_VITIS_LOOP_110_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ sext_ln110 int 62 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "m2sbuf","offset": { "type": "dynamic","port_name": "m2sbuf","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln110", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln110", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln110", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln110 { ap_none {  { sext_ln110 in_data 0 62 } } }
