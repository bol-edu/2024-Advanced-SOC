...
reg rvalid_reg_before_FF;
//reg rvalid_before_FF;
reg [(pDATA_WIDTH-1):0] rdata_reg_before_FF;
//reg [(pDATA_WIDTH-1):0] rdata_before_FF;
reg [(pDATA_WIDTH-1):0] last_rdata;
/////////////// Added in advanced SoC lab1 ///////////////
///// First replace all "rdata_reg" to become "rdata_reg_before_FF", and all "rvalid_reg" to become "rvalid_reg_before_FF" /////
reg rvalid_reg;
...
/////assign rvalid = rvalid_reg_before_FF;
/////assign rdata = rdata_reg_before_FF;
/////////////// Added in advanced SoC lab1 ///////////////
...
always@(posedge axis_clk or negedge axis_rst_n) begin
    if(~axis_rst_n) begin
        ...
        rvalid_reg <= rvalid_reg_before_FF;
        rdata_reg <= rdata_reg_before_FF;
    end
end
//////////////////////////////////////////////////////////
...
always @* begin
    ...
    if(~axis_rst_n) begin
        ...
        rdata_reg_before_FF=0;
        rvalid_reg_before_FF=0;
        ...
        case(state)
            ...
            AXI_Lite_WAIT: begin
                ...
                if(awvalid & wvalid & awready & wready) begin    /////// Write coefficient & ap ///////
                    ...
                    rdata_reg_before_FF=last_rdata;
                    rvalid_reg_before_FF=last_rvalid;
                end
                    ...
                    if(araddr==12'h00) begin
                        ...
                        */
                        ...
                        rdata_reg_before_FF={28'd0,ap_idle_done_start};
                        rvalid_reg_before_FF=1;
                    end
                        ...
                        rdata_reg_before_FF=data_length; //{28'd0,ap_idle_done_start};
                        rvalid_reg_before_FF=1;
                    end
                    else begin
...
always@(posedge axis_clk or negedge axis_rst_n) begin
    if(~axis_rst_n) begin
        ...
        /////rvalid_reg_before_FF <= rvalid_before_FF;
        /////rdata_reg_before_FF <= rdata_before_FF;
        last_rdata <= rdata;
        last_rvalid <= rvalid;
        last_rready <= rready;
