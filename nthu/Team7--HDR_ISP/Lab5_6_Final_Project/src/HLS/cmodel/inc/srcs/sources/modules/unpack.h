#ifndef HDRISP_UNPACK_H_
#define HDRISP_UNPACK_H_

#include "/home/course/ee525201/final_project/ISP1/cmodel/inc/srcs/include/modules/modules.h"
#define MOD_NAME "unpack"

template <int Width, int Height>
class unpack_algorithm
{
public:
  unpack_algorithm(){}
  
  static void UnpackRaw10ToRaw16(uint8_t *raw, 
                                 uint16_t *unpack_raw16, 
								 int width, 
								 int height)
  {
   ...
   * @param height
   */
  static void UnpackRaw12ToRaw16(uint8_t *raw, 
                                 uint16_t *unpack_raw16, 
								 int width, 
								 int height)
  {
   ...
   * @param height
   */
  static void UnpackRaw16ToRaw16(uint8_t *raw, 
                                 uint16_t *unpack_raw16, 
								 int width, 
								 int height)
  {
  ...
  static int MipiDataUnpack(Frame *frame, 
                            const IspPrms *prms)
  {
