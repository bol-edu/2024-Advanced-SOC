#ifndef HDRISP_LTM_H_
#define HDRISP_LTM_H_
...
public:
  ...
  void BgrToYFast(int32_t *bgr, float *y, float *y_log, int width, int height)
  {
  ...
  void BilateralFilter(float *ylog_i, float *bp_log, int kernel_size,
  ...
  int Ltm(Frame *frame, const IspPrms *isp_prm)
  {
      ...
      FOR_ITER(ih, frame->info.height)
      {
          FOR_ITER(iw, frame->info.width)
          {
              ...
              bgr_in[3 * pixel_idx + 0] = int32_t(bgr_in[3 * pixel_idx + 0] * ratio);
              bgr_in[3 * pixel_idx + 1] = int32_t(bgr_in[3 * pixel_idx + 1] * ratio);
              bgr_in[3 * pixel_idx + 2] = int32_t(bgr_in[3 * pixel_idx + 2] * ratio);
  
              bgr_out[3 * pixel_idx + 0] = int32_t(max_out_val * bgr_in[3 * pixel_idx + 0] / max_scale_val);
              bgr_out[3 * pixel_idx + 1] = int32_t(max_out_val * bgr_in[3 * pixel_idx + 1] / max_scale_val);
              bgr_out[3 * pixel_idx + 2] = int32_t(max_out_val * bgr_in[3 * pixel_idx + 2] / max_scale_val);
