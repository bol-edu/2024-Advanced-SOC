...
#include "/home/course/ee525201/final_project/ISP1/hls_c/inc/saturation.h"
...
#include "/home/course/ee525201/final_project/ISP1/cmodel/inc/srcs/sources/modules/saturation.cpp"
...
{	
	...
	HDRISP_IP::stream_sat sat_prmIn;
	HDRISP_IP::SaturationPrms sat_prmTmp;
	
	std::cout << "Test2_1" << std::endl;
	sat_prmTmp.rotate_angle = isp_prms.sat_prms.rotate_angle;
	std::cout << "Test2_2" << std::endl;
	sat_prmIn.write(sat_prmTmp);
	u_saturation.run(dataIn_chn, widthIn, heightIn, sat_prmIn, dataOut_chn);
