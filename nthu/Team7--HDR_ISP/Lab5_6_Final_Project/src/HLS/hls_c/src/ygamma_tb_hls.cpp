...
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_ygamma/hls_c/inc/HDRISP_defs.h"
//=============================================================================================================//

//=============================================================================================================//
//                                              include modified cmodel module                                 //
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/unpack.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/depwl.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/dpc.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/lsc.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/blc.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/wbgain.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/demoasic.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/ccm.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/ltm.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/rgbgamma.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/rgb2yuv.h"
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/ygamma.h"
//#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/contrast.h"
//#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/sharpen.h"
//#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/cns.h"
//#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/wbgain.h"
//=============================================================================================================//
...
#include "/home/m110/m110063553/catapult/test_ygamma/cmodel/inc/sources/modules/ygamma.cpp"
...
//                                              include hls module                                             //
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_ygamma/hls_c/inc/ygamma.h"
//=============================================================================================================//
...
//=============================================================================================================//
    ...
    ygamma_algorithm<iW,iH>    ref_ygamma_inst;	
   	HDRISP_IP::ygamma u_ygamma;
	
//=============================================================================================================//	
//                                     ygamma.h    (modified algorithm)                                           //
//=============================================================================================================//    
...
//=============================================================================================================//  
	...
	HDRISP_IP::stream_ygamma ygamma_prmIn;
	HDRISP_IP::YGammmaCurve ygamma_prmTmp;
 
	ygamma_prmTmp.nums = isp_prms.y_gamma.nums;
	ygamma_prmTmp.in_bits = isp_prms.y_gamma.in_bits;
	ygamma_prmTmp.out_bits = isp_prms.y_gamma.out_bits;
	//std::cout << "isp_prms.y_gamma.nums] = " << isp_prms.y_gamma.nums << std::endl;
	//std::cout << "ygamma_prmTmp.nums = " << ygamma_prmTmp.nums << std::endl;
	//std::cout << "ygamma_prmTmp.in_bits = " << ygamma_prmTmp.in_bits << std::endl;
	//std::cout << "ygamma_prmTmp.out_bits = " << ygamma_prmTmp.out_bits << std::endl;
  
 	for (int i = 0; i < MAX_GAMMA_NUMS; ++i) {
	  ygamma_prmTmp.curve[i] = isp_prms.y_gamma.curve[i];
    std::cout << "ygamma_prmTmp.curve[i] = " << ygamma_prmTmp.curve[i] << std::endl;
	std::cout << "isp_prms.y_gamma.curve[i] = " << isp_prms.y_gamma.curve[i] << std::endl;
    }

  
	//std::cout << "isp_prms.wb_gains.d65_gain[4] = " << isp_prms.wb_gains.d65_gain[4] << std::endl;
	//std::cout << "wbgain_prmTmp.d65_gain[4] = " << wbgain_prmTmp.d65_gain[4] << std::endl;
	std::cout << "Test2_1" << std::endl;
	ygamma_prmIn.write(ygamma_prmTmp);

  
	std::cout << "Test2_2" << std::endl;
	//int max_val = isp_prms.info.max_val;
	u_ygamma.run(dataIn_chn, widthIn, heightIn, ygamma_prmIn, dataOut_chn);
	std::cout << "Test3" << std::endl;
	
	
	
//=============================================================================================================//	
//                                     compare ygamma_algorithm (data1) and ygamma.cpp (data2)                 //
//=============================================================================================================//  	  
	int err_num = 0;
	uint8_t* data1_y;
	uint8_t* data2_y;
...
//=============================================================================================================//	
//                                     compare ygamma_hls (data_hls_out) and ygamma.cpp (data2)                //
//=============================================================================================================//  		
	int hls_err_num = 0;
