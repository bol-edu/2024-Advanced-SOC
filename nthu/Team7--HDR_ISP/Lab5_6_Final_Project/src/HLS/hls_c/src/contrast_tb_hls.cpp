...
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_contrast/hls_c/inc/HDRISP_defs.h"
//=============================================================================================================//

//=============================================================================================================//
//                                              include modified cmodel module                                 //
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/unpack.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/depwl.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/dpc.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/lsc.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/blc.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/wbgain.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/demoasic.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/ccm.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/ltm.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/rgbgamma.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/rgb2yuv.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/ygamma.h"
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/contrast.h"
//#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/sharpen.h"
//#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/cns.h"
//#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/wbgain.h"
//=============================================================================================================//
...
#include "/home/m110/m110063553/catapult/test_contrast/cmodel/inc/sources/modules/contrast.cpp"
...
//                                              include hls module                                             //
//=============================================================================================================//
#include "/home/m110/m110063553/catapult/test_contrast/hls_c/inc/contrast.h"
//=============================================================================================================//
...
//=============================================================================================================//
	...
	HDRISP_IP::contrast u_contrast;
	
//=============================================================================================================//	
//                                     contrast.h    (modified algorithm)                                      //
//=============================================================================================================//    
...
//=============================================================================================================//	
//                                     contrast.cpp    (original algorithm)                                    //
//=============================================================================================================//    
...
//=============================================================================================================//  
	...
	//uint8_t * dataIn_ptr = (uint8_t *)frame3.data.yuv_u8_i.y;
	//uint8_t   data_hls = 0;
	...
	HDRISP_IP::stream_contrast contrast_prmIn;
	HDRISP_IP::ContrastPrms contrast_prmTmp;
 
	contrast_prmTmp.ratio = isp_prms.contrast_prms.ratio;
    std::cout << "isp_prms.contrast_prms.ratio = " << isp_prms.contrast_prms.ratio << std::endl;
	std::cout << "contrast_prmTmp.ratio = " << contrast_prmTmp.ratio << std::endl;

  
	std::cout << "Test2_1" << std::endl;
	contrast_prmIn.write(contrast_prmTmp);

  
	std::cout << "Test2_2" << std::endl;
	u_contrast.run(dataIn_chn, widthIn, heightIn, contrast_prmIn, dataOut_chn);
	std::cout << "Test3" << std::endl;
 
  
//=============================================================================================================//	
//                                     compare contrast_algorithm (data1) and contrast.cpp (data2)             //
//=============================================================================================================//  	
	int err_num = 0;
	uint8_t* data1_y;
	uint8_t* data2_y;
...
//=============================================================================================================//	
//                                     compare contrast_hls (data_hls_out) and contrast.cpp (data2)            //
//=============================================================================================================//  	
