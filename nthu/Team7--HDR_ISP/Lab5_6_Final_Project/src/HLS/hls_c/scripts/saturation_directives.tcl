...
solution file add ../hls_c/inc/saturation.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/saturation_tb.cpp -type C++ -exclude true
...
solution file add ../cmodel/inc/srcs/sources/modules/saturation.h -type CHEADER -exclude true
...
go assembly
directive set /HDRISP_IP::saturation/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::saturation/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::saturation/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::saturation/sat_prms:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::saturation -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::saturation/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
