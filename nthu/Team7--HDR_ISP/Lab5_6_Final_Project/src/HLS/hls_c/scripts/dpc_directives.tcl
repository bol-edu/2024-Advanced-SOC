...
solution file add ../hls_c/inc/dpc.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/dpc_tb.cpp -type C++ -exclude true
...
go assembly
directive set /HDRISP_IP::dpc/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::dpc/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::dpc/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::dpc/dpc_prms:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::dpc/run/line_buf0:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::dpc/run/line_buf0:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::dpc/run/line_buf0:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::dpc/run/line_buf1:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::dpc/run/line_buf1:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::dpc/run/line_buf1:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::dpc/run/line_buf2:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::dpc/run/line_buf2:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::dpc/run/line_buf2:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::dpc/run/line_buf3:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::dpc/run/line_buf3:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::dpc/run/line_buf3:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::dpc -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::dpc/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
