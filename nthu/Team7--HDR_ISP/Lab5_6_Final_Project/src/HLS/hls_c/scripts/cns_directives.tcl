...
solution file add ../hls_c/inc/cns.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/cns_tb.cpp -type C++ -exclude true
...
solution file add ../cmodel/inc/srcs/sources/modules/ltm.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/rgbgamma.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/rgb2yuv.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/ygamma.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/contrast.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/sharpen.h -type CHEADER -exclude true
solution file add ../cmodel/inc/srcs/sources/modules/cns.h -type CHEADER -exclude true
...
go assembly
directive set /HDRISP_IP::cns/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::cns/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::cns/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::cns/run/line_buf0:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::cns/run/line_buf0:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::cns/run/line_buf0:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::cns/run/line_buf1:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::cns/run/line_buf1:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::cns/run/line_buf1:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::cns -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::cns/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
