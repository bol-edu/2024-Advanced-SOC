...
solution file add ../hls_c/inc/demosaic.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/demosaic_tb.cpp -type C++ -exclude true
...
go assembly
directive set /HDRISP_IP::demosaic/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::demosaic/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::demosaic/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::demosaic/cfa:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::demosaic/max_val:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::demosaic/run/line_buf0:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::demosaic/run/line_buf0:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::demosaic/run/line_buf0:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::demosaic/run/line_buf1:rsc -MAP_TO_MODULE ccs_sample_mem.ccs_ram_sync_singleport
directive set /HDRISP_IP::demosaic/run/line_buf1:rsc -EXTERNAL_MEMORY true
directive set /HDRISP_IP::demosaic/run/line_buf1:rsc -GEN_EXTERNAL_ENABLE true
directive set /HDRISP_IP::demosaic -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::demosaic/run/RGB -PIPELINE_INIT_INTERVAL 1
go architect
go extract
