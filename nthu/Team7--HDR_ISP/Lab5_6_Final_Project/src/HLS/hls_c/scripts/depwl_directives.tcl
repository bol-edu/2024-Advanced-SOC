...
solution file add ../hls_c/inc/depwl.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/depwl_tb.cpp -type C++ -exclude true
...
go assembly
directive set /HDRISP_IP::depwl/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::depwl/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::depwl/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::depwl/max_val:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::depwl/pwl_prms:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::depwl -RESET_CLEARS_ALL_REGS no
directive set /HDRISP_IP::depwl/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
