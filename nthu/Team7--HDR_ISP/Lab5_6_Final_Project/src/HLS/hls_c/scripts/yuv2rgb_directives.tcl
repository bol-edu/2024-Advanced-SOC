...
solution file add ../hls_c/inc/yuv2rgb.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/yuv2rgb_tb.cpp -type C++ -exclude true
...
solution file add ../cmodel/inc/srcs/sources/modules/yuv2rgb.h -type CHEADER -exclude true
...
go assembly
directive set /HDRISP_IP::yuv2bgr/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::yuv2bgr/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::yuv2bgr/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::yuv2bgr -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::yuv2bgr/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
