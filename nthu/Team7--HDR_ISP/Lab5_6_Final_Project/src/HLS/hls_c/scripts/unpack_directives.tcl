...
solution options set /Flows/SCVerify/INVOKE_ARGS /home/course/ee525201/final_project/ISP1/cmodel/inc/cfgs/isp_config_cannon.json
solution file add ../hls_c/inc/unpack.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/unpack_tb.cpp -type C++ -exclude true
...
go assembly
directive set /HDRISP_IP::unpack/mode:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::unpack/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::unpack/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::unpack/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::unpack -RESET_CLEARS_ALL_REGS no
directive set /HDRISP_IP::unpack/run/RAW16 -PIPELINE_INIT_INTERVAL 2
go architect
go extract
