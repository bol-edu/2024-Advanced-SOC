...
solution file add ../hls_c/inc/lsc.h -type CHEADER
solution file add ../hls_c/inc/HDRISP_defs.h -type CHEADER
solution file add ../hls_c/src/lsc_tb.cpp -type C++ -exclude true
...
go assembly
directive set /HDRISP_IP::lsc/dat_in:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::lsc/widthIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/heightIn:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/cfa:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/max_val:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/mesh_box_width:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/mesh_box_height:rsc -MAP_TO_MODULE {[DirectInput]}
directive set /HDRISP_IP::lsc/lsc_prms:rsc -MAP_TO_MODULE ccs_ioport.ccs_in_wait_coupled
directive set /HDRISP_IP::lsc -RESET_CLEARS_ALL_REGS no
#directive set /HDRISP_IP::lsc/run/ROW -PIPELINE_INIT_INTERVAL 1
go architect
go extract
